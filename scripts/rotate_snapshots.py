...
for example, /opt/aiy, it assumes snapshots are staged in /opt/aiy/snapshots,
and all symlinks to said snapshots are contained under /opt/aiy/instances. It will delete all snapshots that are not
...
def usage():
    ...
    print(
        f'   --dir=<aiy-base-dir>   Base directory for aiy. Must contain /snapshots and /instances dirs')
