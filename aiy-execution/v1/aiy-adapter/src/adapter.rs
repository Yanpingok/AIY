...
mod checked {
    ...
    use aiy_move_natives::{object_runtime::ObjectRuntime, NativesCostTable};
    ...
    pub fn run_metered_move_bytecode_verifier(
        ...
        for module in modules.iter() {
            ...
            if let Err(e) = verify_module_with_config_metered(verifier_config, module, meter) {
                ...
                aiy_verify_module_metered_check_timeout_only(module, &BTreeMap::new(), meter)
            {
                ...
                metrics
                    .verifier_timeout_metrics
                    .with_label_values(&[
                        BytecodeVerifierMetrics::AIY_VERIFIER_TAG,
                        BytecodeVerifierMetrics::TIMEOUT_TAG,
                    ])
                    .inc();
                return Err(err.into());
