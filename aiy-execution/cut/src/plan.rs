...
mod tests {
    ...
    fn test_workspace_read() {
        ...
        let aiy_execution = root.join("aiy-execution");
        ...
        // Other examples
        assert!(ws.members.contains(&aiy_execution));
    ...
    fn test_no_workspace() {
        ...
        expect!["No [workspace] found at $PATH/aiy-execution/cut/Cargo.toml/Cargo.toml"]
    ...
    fn test_cut_plan_discover() {
        ...
        let plan = CutPlan::discover(Args {
            ...
            packages: vec![
                ...
                "aiy-adapter-latest".to_string(),
                "aiy-execution-cut".to_string(),
                "aiy-verifier-latest".to_string(),
            ],
        })
        .unwrap();
        ...
        expect![[r#"
            CutPlan {
                root: "$PATH",
                directories: {
                    "$PATH/aiy-execution/cut-cut",
                    "$PATH/aiy-execution/cut-move-core-types",
                    "$PATH/aiy-execution/exec-cut",
                },
                packages: {
                    "move-core-types": CutPackage {
                        dst_name: "move-core-types-feature",
                        src_path: "$PATH/external-crates/move/crates/move-core-types",
                        dst_path: "$PATH/aiy-execution/cut-move-core-types",
                        ws_state: Exclude,
                    },
                    "aiy-adapter-latest": CutPackage {
                        dst_name: "aiy-adapter-feature",
                        src_path: "$PATH/aiy-execution/latest/aiy-adapter",
                        dst_path: "$PATH/aiy-execution/exec-cut/aiy-adapter",
                        ws_state: Member,
                    },
                    "aiy-execution-cut": CutPackage {
                        dst_name: "aiy-execution-cut-feature",
                        src_path: "$PATH/aiy-execution/cut",
                        dst_path: "$PATH/aiy-execution/cut-cut",
                        ws_state: Member,
                    },
                    "aiy-verifier-latest": CutPackage {
                        dst_name: "aiy-verifier-feature",
                        src_path: "$PATH/aiy-execution/latest/aiy-verifier",
                        dst_path: "$PATH/aiy-execution/exec-cut/aiy-verifier",
                        ws_state: Member,
                    },
                },
            }"#]]
        ...
        expect![[r#"
            ...
            new [workspace] members:
             - to:   aiy-adapter-feature
                     aiy-execution/exec-cut/aiy-adapter
               from: aiy-adapter-latest
                     aiy-execution/latest/aiy-adapter
             - to:   aiy-execution-cut-feature
                     aiy-execution/cut-cut
               from: aiy-execution-cut
                     aiy-execution/cut
             - to:   aiy-verifier-feature
                     aiy-execution/exec-cut/aiy-verifier
               from: aiy-verifier-latest
                     aiy-execution/latest/aiy-verifier

            new [workspace] excludes:
             - to:   move-core-types-feature
                     aiy-execution/cut-move-core-types
    ...
    fn test_cut_plan_discover_new_top_level_destination() {
        ...
        expect![[r#"
            CutPlan {
                root: "$PATH",
                directories: {
                    "$PATH/aiy-execution/feature",
                },
                packages: {
                    "move-core-types": CutPackage {
                        dst_name: "move-core-types-feature",
                        src_path: "$PATH/external-crates/move/crates/move-core-types",
                        dst_path: "$PATH/aiy-execution/feature/move/crates/move-core-types",
                        ws_state: Exclude,
                    },
                    "aiy-adapter-latest": CutPackage {
                        dst_name: "aiy-adapter-feature",
                        src_path: "$PATH/aiy-execution/latest/aiy-adapter",
                        dst_path: "$PATH/aiy-execution/feature/aiy-adapter",
                        ws_state: Member,
                    },
                    "aiy-execution-cut": CutPackage {
                        dst_name: "aiy-execution-cut-feature",
                        src_path: "$PATH/aiy-execution/cut",
                        dst_path: "$PATH/aiy-execution/feature/cut",
                        ws_state: Member,
                    },
                    "aiy-verifier-latest": CutPackage {
                        dst_name: "aiy-verifier-feature",
                        src_path: "$PATH/aiy-execution/latest/aiy-verifier",
                        dst_path: "$PATH/aiy-execution/feature/aiy-verifier",
                        ws_state: Member,
                    },
                },
            }"#]]
