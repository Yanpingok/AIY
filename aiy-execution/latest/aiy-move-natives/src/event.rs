...
use aiy_types::{base_types::ObjectID, error::VMMemoryLimitExceededSubStatusCode};
...
pub fn emit_authenticated_impl(
    ...
    // This type is always aiy::event::EventStreamHead
...
struct StreamRef {
    ...
    stream_id: Value,
    // The type of the stream head. Should always be `aiy::event::EventStreamHead`
    stream_head_ty: Type,
}
