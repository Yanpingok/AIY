...
use aiy_types::{
    ...
    AIY_FRAMEWORK_ADDRESS, AIY_SYSTEM_ADDRESS,
};
...
#[cfg(msim)]
const AIY_DENY_LIST_OBJECT_CREATE: FunctionIdent = (
    &AIY_FRAMEWORK_ADDRESS,
    COIN_MODULE_NAME,
...
#[cfg(not(msim))]
const FUNCTIONS_TO_SKIP: &[FunctionIdent] = &[AIY_SYSTEM_CREATE, AIY_CLOCK_CREATE];
