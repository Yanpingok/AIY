...
mod checked {
    ...
    use aiy_types::execution_status::CommandArgumentError;
    use aiy_types::storage::PackageObject;
    use aiy_types::{
        balance::Balance,
        base_types::{MoveObjectType, ObjectID, SequenceNumber, AiyAddress, TxContext},
        coin::Coin,
    ...
    impl<'vm, 'state, 'a> ExecutionContext<'vm, 'state, 'a> {
        pub fn new(
            ...
            // TODO remove this
            let linkage = LinkageView::new(Box::new(state_view.as_aiy_resolver()), init_linkage);
            ...
            // exist. Plus, Aiy Move does not use these changes or events
    ...
    // Create a new Session aiytable for resolving type and type operations rather than execution
