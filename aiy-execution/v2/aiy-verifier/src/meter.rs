...
struct AiyVerifierMeterBounds {
    name: String,
    ticks: u128,
    max_ticks: Option<u128>,
}

impl AiyVerifierMeterBounds {
...
pub struct AiyVerifierMeter {
    transaction_bounds: AiyVerifierMeterBounds,
    package_bounds: AiyVerifierMeterBounds,
    module_bounds: AiyVerifierMeterBounds,
    function_bounds: AiyVerifierMeterBounds,
}

impl AiyVerifierMeter {
    ...
    fn get_bounds_mut(&mut self, scope: Scope) -> &mut AiyVerifierMeterBounds {
        match scope {
    ...
    fn get_bounds(&self, scope: Scope) -> &AiyVerifierMeterBounds {
        match scope {
...
impl Meter for AiyVerifierMeter {
