...
<dl>
<dt>
<code>treasuries: <a href="../aiy/object_bag.md#aiy_object_bag_ObjectBag">aiy::object_bag::ObjectBag</a></code>
</dt>
<dd>
</dd>
<dt>
<code>supported_tokens: <a href="../aiy/vec_map.md#aiy_vec_map_VecMap">aiy::vec_map::VecMap</a>&lt;<a href="../std/type_name.md#std_type_name_TypeName">std::type_name::TypeName</a>, <a href="../bridge/treasury.md#bridge_treasury_BridgeTokenMetadata">bridge::treasury::BridgeTokenMetadata</a>&gt;</code>
</dt>
<dd>
</dd>
<dt>
<code>id_token_type_map: <a href="../aiy/vec_map.md#aiy_vec_map_VecMap">aiy::vec_map::VecMap</a>&lt;u8, <a href="../std/type_name.md#std_type_name_TypeName">std::type_name::TypeName</a>&gt;</code>
</dt>
<dd>
</dd>
<dt>
<code>waiting_room: <a href="../aiy/bag.md#aiy_bag_Bag">aiy::bag::Bag</a></code>
</dt>
<dd>
</dd>
</dl>
...
<dt>
<code>uc: <a href="../aiy/package.md#aiy_package_UpgradeCap">aiy::package::UpgradeCap</a></code>
</dt>
<dd>
</dd>
<dt>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../bridge/treasury.md#bridge_treasury_create">create</a>(ctx: &<b>mut</b> <a href="../aiy/tx_context.md#aiy_tx_context_TxContext">aiy::tx_context::TxContext</a>): <a href="../bridge/treasury.md#bridge_treasury_BridgeTreasury">bridge::treasury::BridgeTreasury</a>
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../bridge/treasury.md#bridge_treasury_burn">burn</a>&lt;T&gt;(self: &<b>mut</b> <a href="../bridge/treasury.md#bridge_treasury_BridgeTreasury">bridge::treasury::BridgeTreasury</a>, token: <a href="../aiy/coin.md#aiy_coin_Coin">aiy::coin::Coin</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../bridge/treasury.md#bridge_treasury_mint">mint</a>&lt;T&gt;(self: &<b>mut</b> <a href="../bridge/treasury.md#bridge_treasury_BridgeTreasury">bridge::treasury::BridgeTreasury</a>, amount: u64, ctx: &<b>mut</b> <a href="../aiy/tx_context.md#aiy_tx_context_TxContext">aiy::tx_context::TxContext</a>): <a href="../aiy/coin.md#aiy_coin_Coin">aiy::coin::Coin</a>&lt;T&gt;
</code></pre>
