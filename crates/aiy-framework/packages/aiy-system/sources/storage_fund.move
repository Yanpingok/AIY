...
module aiy_system::storage_fund;
...
public struct StorageFund has store {
    total_object_storage_rebates: Balance<AIY>,
    non_refundable_balance: Balance<AIY>,
}

/// Called by `aiy_system` at genesis time.
public(package) fun new(initial_fund: Balance<AIY>): StorageFund {
    StorageFund {
...
/// Called by `aiy_system` at epoch change times to process the inflows and outflows of storage fund.
