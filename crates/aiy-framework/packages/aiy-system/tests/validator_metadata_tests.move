...
#[test_only]
module aiy_system::validator_metadata_tests;

use aiy::test_scenario::{Self, Scenario};
use aiy::url;
use aiy_system::aiy_system::AiySystemState;
use aiy_system::test_runner::{Self, TestRunner};
...
fun active_validator_update_metadata() {
    ...
    let validator = validator_builder::preset()
        .aiy_address(new_validator_addr)
...
// Note: `pop` MUST be a valid signature using aiy_address and protocol_pubkey_bytes.
