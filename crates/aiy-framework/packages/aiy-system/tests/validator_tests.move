...
#[test_only]
module aiy_system::validator_tests;
...
fun validator_owner_flow() {
    ...
    assert_eq!(validator.aiy_address(), @2);
...
fun pending_validator_flow() {
    ...
    runner.owned_tx!<StakedAiy>(|staked_aiy| {
        let withdrawn_balance = validator
            .request_withdraw_stake(staked_aiy, runner.ctx())
            .destroy_for_testing();
...
#[test, expected_failure(abort_code = aiy_system::validator::EMetadataInvalidPubkey)]
...
#[test, expected_failure(abort_code = aiy_system::validator::EMetadataInvalidNetPubkey)]
...
#[test, expected_failure(abort_code = aiy_system::validator::EMetadataInvalidWorkerPubkey)]
...
#[test, expected_failure(abort_code = aiy_system::validator::EMetadataInvalidNetAddr)]
...
#[test, expected_failure(abort_code = aiy_system::validator::EMetadataInvalidP2pAddr)]
...
#[test, expected_failure(abort_code = aiy_system::validator::EMetadataInvalidPrimaryAddr)]
...
#[test, expected_failure(abort_code = aiy_system::validator::EMetadataInvalidWorkerAddr)]
...
#[test, expected_failure(abort_code = aiy_system::validator::EInvalidProofOfPossession)]
...
#[
    test,
    expected_failure(
        abort_code = aiy_system::validator::EValidatorMetadataExceedingLengthLimit,
    ),
]
