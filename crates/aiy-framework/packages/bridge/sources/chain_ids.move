...
// Chain IDs
const AIY_MAINNET: u8 = 0;
const AIY_TESTNET: u8 = 1;
const AIY_CUSTOM: u8 = 2;
...
public fun aiy_mainnet(): u8 { AIY_MAINNET }

public fun aiy_testnet(): u8 { AIY_TESTNET }

public fun aiy_custom(): u8 { AIY_CUSTOM }
...
public fun valid_routes(): vector<BridgeRoute> {
    vector[
        BridgeRoute { source: AIY_MAINNET, destination: ETH_MAINNET },
        BridgeRoute { source: ETH_MAINNET, destination: AIY_MAINNET },
        BridgeRoute { source: AIY_TESTNET, destination: ETH_SEPOLIA },
        BridgeRoute { source: AIY_TESTNET, destination: ETH_CUSTOM },
        BridgeRoute { source: AIY_CUSTOM, destination: ETH_CUSTOM },
        BridgeRoute { source: AIY_CUSTOM, destination: ETH_SEPOLIA },
        BridgeRoute { source: ETH_SEPOLIA, destination: AIY_TESTNET },
        BridgeRoute { source: ETH_SEPOLIA, destination: AIY_CUSTOM },
        BridgeRoute { source: ETH_CUSTOM, destination: AIY_TESTNET },
        BridgeRoute { source: ETH_CUSTOM, destination: AIY_CUSTOM },
    ]
}
...
#[test]
fun test_chains_ok() {
    assert_valid_chain_id(AIY_MAINNET);
    assert_valid_chain_id(AIY_TESTNET);
    assert_valid_chain_id(AIY_CUSTOM);
...
#[test, expected_failure(abort_code = EInvalidBridgeRoute)]
fun test_aiy_chains_error() {
    // this will break if we add one more aiy chain id and should be corrected
...
#[test, expected_failure(abort_code = EInvalidBridgeRoute)]
fun test_routes_err_aiy_1() {
    get_route(AIY_MAINNET, AIY_MAINNET);
}

#[test, expected_failure(abort_code = EInvalidBridgeRoute)]
fun test_routes_err_aiy_2() {
    get_route(AIY_MAINNET, AIY_TESTNET);
}

#[test, expected_failure(abort_code = EInvalidBridgeRoute)]
fun test_routes_err_aiy_3() {
    get_route(AIY_MAINNET, ETH_SEPOLIA);
}

#[test, expected_failure(abort_code = EInvalidBridgeRoute)]
fun test_routes_err_aiy_4() {
    get_route(AIY_MAINNET, ETH_CUSTOM);
}
...
fun test_routes_err_eth_3() {
    get_route(ETH_MAINNET, AIY_CUSTOM);
}

#[test, expected_failure(abort_code = EInvalidBridgeRoute)]
fun test_routes_err_eth_4() {
    get_route(ETH_MAINNET, AIY_TESTNET);
}
