...
#[test_only]
module aiy::test_scenario_tests;
...
fun create_system_objects() {
    ...
    let clock = scenario.take_shared<aiy::clock::Clock>();
    test_scenario::return_shared(clock);

    let random = scenario.take_shared<aiy::random::Random>();
    test_scenario::return_shared(random);

    let deny_list = scenario.take_shared<aiy::deny_list::DenyList>();
