...
module aiy::kiosk_tests;

use aiy::coin;
use aiy::kiosk_test_utils::{Self as test, Asset};
use aiy::aiy::AIY;
...
#[test]
#[expected_failure(abort_code = aiy::kiosk::EItemLocked)]
...
fun test_purchase() {
    ...
    let payment = coin::mint_for_testing<AIY>(AMT, ctx);
...
#[test]
#[expected_failure(abort_code = aiy::kiosk::ENotListed)]
...
#[test]
#[expected_failure(abort_code = aiy::kiosk::EListedExclusively)]
...
#[allow(unused_field)]
public struct WrongAsset has key, store { id: aiy::object::UID }

#[test]
#[expected_failure(abort_code = aiy::kiosk::EItemNotFound)]
...
#[test]
#[expected_failure(abort_code = aiy::kiosk::EIncorrectAmount)]
fun test_purchase_wrong_amount() {
    ...
    kiosk.place_and_list(&owner_cap, asset, AMT);
    let payment = coin::mint_for_testing<AIY>(AMT + 1, ctx);
...
#[test]
#[expected_failure(abort_code = aiy::kiosk::EAlreadyListed)]
...
#[test]
#[expected_failure(abort_code = aiy::kiosk::ENotEmpty)]
...
#[test]
#[expected_failure(abort_code = aiy::kiosk::ENotEnough)]
...
fun test_uid_access() {
    ...
    let uid = kiosk.uid();
    assert!(aiy::object::uid_to_inner(uid) == aiy::object::id(&kiosk));

    test::return_kiosk(kiosk, owner_cap, ctx);
}

#[test]
#[expected_failure(abort_code = aiy::kiosk::EUidAccessNotAllowed)]
