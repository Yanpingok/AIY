...
#[test_only]
module aiy::malicious_policy {
    use aiy::transfer_policy::{Self as policy, TransferRequest};
...
#[test_only]
module aiy::transfer_policy_tests {
    use aiy::coin;
    use aiy::dummy_policy;
    use aiy::malicious_policy;
    use aiy::package;
    use aiy::transfer_policy::{Self as policy, TransferPolicy, TransferPolicyCap};
    ...
    #[test]
    #[expected_failure(abort_code = aiy::transfer_policy::EPolicyNotSatisfied)]
    ...
    #[test]
    #[expected_failure(abort_code = aiy::transfer_policy::ERuleAlreadySet)]
    ...
    #[test]
    #[expected_failure(abort_code = aiy::transfer_policy::EIllegalRule)]
