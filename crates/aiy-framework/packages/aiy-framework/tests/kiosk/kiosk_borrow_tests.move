...
module aiy::kiosk_borrow_tests;

use aiy::kiosk_test_utils::{Self as utils, Asset};
...
#[test]
#[expected_failure(abort_code = aiy::kiosk::ENotOwner)]
...
#[test]
#[expected_failure(abort_code = aiy::kiosk::EItemIsListed)]
...
#[test]
#[expected_failure(abort_code = aiy::kiosk::EWrongKiosk)]
...
#[test]
#[expected_failure(abort_code = aiy::kiosk::EItemMismatch)]
