...
#[test_only]
module aiy::royalty_policy_tests {
    use aiy::coin;
    use aiy::royalty_policy;
    use aiy::aiy::AIY;
    use aiy::transfer_policy as policy;
    use aiy::transfer_policy_tests as test;
    ...
    fun test_default_flow() {
        ...
        let mut payment = coin::mint_for_testing<AIY>(2000, ctx);
    ...
    #[test]
    #[expected_failure(abort_code = aiy::royalty_policy::EIncorrectArgument)]
    ...
    #[test]
    #[expected_failure(abort_code = aiy::royalty_policy::EInsufficientAmount)]
    fun test_insufficient_amount() {
        ...
        let mut request = policy::new_request(test::fresh_id(ctx), 100_000, test::fresh_id(ctx));
        let mut payment = coin::mint_for_testing<AIY>(999, ctx);
