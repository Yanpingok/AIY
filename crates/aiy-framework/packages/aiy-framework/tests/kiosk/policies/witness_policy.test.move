...
#[test_only]
module aiy::witness_policy_tests {
    use aiy::transfer_policy as policy;
    use aiy::transfer_policy_tests::{Self as test, Asset};
    use aiy::witness_policy;
    ...
    #[test]
    #[expected_failure(abort_code = aiy::witness_policy::ERuleNotFound)]
