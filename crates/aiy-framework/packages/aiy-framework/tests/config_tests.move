...
#[test_only]
module aiy::config_tests;

use std::unit_test::assert_eq;
use aiy::config::{Self, Config};
...
fun config_create<WriteCap>(cap: &mut WriteCap, ctx: &mut TxContext) {
    aiy::config::share(aiy::config::new(cap, ctx))
}
...
#[test, expected_failure(abort_code = aiy::config::EAlreadySetForEpoch)]
...
#[test, expected_failure(abort_code = aiy::config::ENotSetForEpoch)]
...
#[test, expected_failure(abort_code = aiy::dynamic_field::EFieldTypeMismatch)]
