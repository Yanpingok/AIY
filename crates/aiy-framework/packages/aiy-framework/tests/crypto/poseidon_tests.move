...
#[test_only]
module aiy::poseidon_tests;

use aiy::poseidon::poseidon_bn254;
...
#[test]
#[expected_failure(abort_code = aiy::poseidon::ENonCanonicalInput)]
...
#[test]
#[expected_failure(abort_code = aiy::poseidon::EEmptyInput)]
