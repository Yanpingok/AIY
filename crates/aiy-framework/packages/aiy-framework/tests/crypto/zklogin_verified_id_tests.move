...
#[test_only]
module aiy::zklogin_verified_id_tests;

use aiy::test_scenario;
use aiy::zklogin_verified_id::{check_zklogin_id, verify_zklogin_id};

#[test]
#[expected_failure(abort_code = aiy::zklogin_verified_id::EFunctionDisabled)]
