...
#[test_only]
module aiy::coin_registry_tests;

use std::string::String;
use std::unit_test::assert_eq;
use aiy::coin::{Self, DenyCapV2, TreasuryCap, CoinMetadata};
use aiy::coin_registry::{Self, Currency, CurrencyInitializer, CoinRegistry};
...
fun receive_promote() {
    ...
    let currency = test_scenario::most_recent_receiving_ticket<Currency<COIN_REGISTRY_TESTS>>(
        &object::aiy_coin_registry_address().to_id(),
    );
