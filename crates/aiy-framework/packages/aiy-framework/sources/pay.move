...
/// This module provides handy functionality for wallets and `aiy::Coin` management.
module aiy::pay;
...
/// Aborts with `aiy::balance::ENotEnough` if `amount` is greater than the balance in `c`
