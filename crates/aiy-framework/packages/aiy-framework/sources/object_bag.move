...
/// Similar to `aiy::bag`, an `ObjectBag` is a heterogeneous map-like collection. But unlike
/// `aiy::bag`, the values bound to these dynamic fields _must_ be objects themselves. This allows
/// for the objects to still exist in storage, which may be important for external tools.
/// The difference is otherwise not observable from within Move.
module aiy::object_bag;
