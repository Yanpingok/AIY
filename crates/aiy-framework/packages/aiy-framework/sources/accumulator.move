...
module aiy::accumulator;

use aiy::dynamic_field;
use aiy::object::aiy_accumulator_root_address;
...
fun create(ctx: &TxContext) {
    ...
    transfer::share_object(AccumulatorRoot {
        id: object::aiy_accumulator_root_object_id(),
    })
}
...
/// `T` is the type of the accumulated value, e.g. `Balance<AIY>`
...
public(package) fun accumulator_address<T>(address: address): address {
    ...
    dynamic_field::hash_type_and_key(aiy_accumulator_root_address(), key)
}
