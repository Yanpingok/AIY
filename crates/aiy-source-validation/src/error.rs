...
use aiy_json_rpc_types::AiyRawMoveObject;
use aiy_package_management::PublishedAtError;
use aiy_sdk::error::Error as SdkError;
use aiy_types::{base_types::ObjectID, error::AiyObjectResponseError};
...
pub enum Error {
    ...
    #[error("Dependency ID contains a Aiy object, not a Move package: {0}")]
    ObjectFoundWhenPackageExpected(ObjectID, AiyRawMoveObject),
    ...
    AiyObjectRefFailure(AiyObjectResponseError),
