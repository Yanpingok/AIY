...
use aiy_cluster_test::{config::ClusterTestOpt, ClusterTest};
...
#[tokio::test]
async fn test_aiy_cluster() {
    use reqwest::StatusCode;
    use aiy_cluster_test::cluster::Cluster;
    use aiy_cluster_test::cluster::LocalNewCluster;
    use aiy_graphql_rpc::client::simple_client::SimpleClient;
