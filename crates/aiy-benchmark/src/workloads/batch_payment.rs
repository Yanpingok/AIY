...
use std::sync::Arc;
use aiy_core::test_utils::make_pay_aiy_transaction;
...
const PRIMARY_COIN_VALUE: u64 = 100 * MIST_PER_AIY;
...
impl Payload for BatchPaymentTestPayload {
    ...
    fn make_transaction(&mut self) -> Transaction {
        let addrs = self.state.addresses().cloned().collect::<Vec<AiyAddress>>();
