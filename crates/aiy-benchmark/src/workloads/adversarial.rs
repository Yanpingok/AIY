...
use aiy_types::base_types::{random_object_ref, ObjectRef};
use aiy_types::effects::TransactionEffectsAPI;
use aiy_types::transaction::Command;
use aiy_types::transaction::{CallArg, ObjectArg};
use aiy_types::{base_types::ObjectID, object::Owner};
use aiy_types::{base_types::AiyAddress, crypto::get_key_pair, transaction::Transaction};
use aiy_types::{transaction::TransactionData, utils::to_sender_signed_transaction};
use tracing::debug;
...
impl Payload for AdversarialTestPayload {
    fn make_new_payload(&mut self, effects: &ExecutionEffects) {
        ...
        let stat = match effects {
            ...
            ExecutionEffects::AiyTransactionBlockEffects(_) => unimplemented!("Not impl"),
        };
