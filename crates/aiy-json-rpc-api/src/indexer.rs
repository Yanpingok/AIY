...
use aiy_json_rpc_types::{
    DynamicFieldPage, EventFilter, EventPage, ObjectsPage, Page, AiyEvent, AiyObjectResponse,
...
#[open_rpc(namespace = "aiyx", tag = "Extended API")]
...
pub trait IndexerApi {
    ...
    /// Please use aiyx_queryObjects if this is a concern.
    ...
    /// Subscribe to a stream of Aiy event
    #[subscription(name = "subscribeEvent", item = AiyEvent)]
    fn subscribe_event(
        &self,
    ...
    /// Subscribe to a stream of Aiy transaction effects
    #[subscription(name = "subscribeTransaction", item = AiyTransactionBlockEffects)]
