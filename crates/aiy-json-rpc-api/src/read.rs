...
use aiy_json_rpc_types::{
    Checkpoint, CheckpointId, CheckpointPage, AiyEvent, AiyGetPastObjectRequest,
    AiyObjectDataOptions, AiyObjectResponse, AiyPastObjectResponse, AiyTransactionBlockResponse,
    AiyTransactionBlockResponseOptions,
};
use aiy_json_rpc_types::{ProtocolConfigResponse, ZkLoginIntentScope, ZkLoginVerifyResult};
...
#[open_rpc(namespace = "aiy", tag = "Read API")]
