...
pub struct JsonRpcMetrics {
    ...
    pub get_stake_aiy_result_size: Histogram,
    pub get_stake_aiy_result_size_total: IntCounter,

    pub get_stake_aiy_latency: Histogram,
    pub get_delegated_aiy_latency: Histogram,
...
impl JsonRpcMetrics {
    pub fn new(registry: &prometheus::Registry) -> Self {
        Self {
            ...
            .unwrap(),
            get_stake_aiy_result_size: register_histogram_with_registry!(
                "json_rpc_get_stake_aiy_result_size",
                "The return size for get_stake_aiy",
                mysten_metrics::COUNT_BUCKETS.to_vec(),
                registry,
            )
            .unwrap(),
            get_stake_aiy_result_size_total: register_int_counter_with_registry!(
                "json_rpc_get_stake_aiy_result_size_total",
                "The total return size for get_stake_aiy",
                registry
            )
            .unwrap(),
            get_stake_aiy_latency: register_histogram_with_registry!(
                "get_stake_aiy_latency",
                "The latency of get stake aiy, in ms",
                mysten_metrics::COARSE_LATENCY_SEC_BUCKETS.to_vec(),
                registry,
            )
            .unwrap(),
            get_delegated_aiy_latency: register_histogram_with_registry!(
                "get_delegated_aiy_latency",
                "The latency of get delegated aiy, in ms",
                mysten_metrics::COARSE_LATENCY_SEC_BUCKETS.to_vec(),
                registry,
            )
            .unwrap(),
