...
This document lays out the step-by-step process for orchestrating a Aiy Genesis Ceremony.
...
- An Ed25519 key can be created using `aiy keytool generate`
...
$ aiy genesis-ceremony add-validator \
...
```
$ aiy genesis-ceremony add-gas-object \
    --address <AiyAddress> \
    --object-id <ObjectId> \
    --valud <# of aiy coins>
$ git add .
...
```
$ aiy genesis-ceremony verify-and-sign \
    --key-file <path to key file>
$ git add .
