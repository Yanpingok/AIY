...
use crate::{
    client_commands::{
        dry_run_or_execute_or_serialize, GasDataArgs, AiyClientCommandResult, TxProcessingArgs,
    },
    client_ptb::{
...
use aiy_sdk::{wallet_context::WalletContext, AiyClient};
use aiy_types::{
    base_types::ObjectID,
...
pub fn ptb_description() -> clap::Command {
    clap::Command::new("aiy client ptb")
        .about(
        ...
        .long_help(
            ...
            \n --make-move-vec <aiy::coin::Coin<aiy::aiy::AIY>> [gas]"
        )
