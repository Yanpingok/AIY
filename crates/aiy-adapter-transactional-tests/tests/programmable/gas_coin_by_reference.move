...
//> test::m1::t1<aiy::coin::Coin<aiy::aiy::AIY>>(Gas)

//# programmable --sender A
//> test::m1::t2<aiy::coin::Coin<aiy::aiy::AIY>>(Gas)

//# programmable --sender A
//> test::m1::t2<aiy::coin::Coin<aiy::aiy::AIY>>(Gas)

//# programmable --sender A
//> test::m1::t4<aiy::coin::Coin<aiy::aiy::AIY>>(Gas)

//# programmable --sender A
//> test::m1::t5<aiy::coin::Coin<aiy::aiy::AIY>>(Gas)

//# programmable --sender A
//> test::m1::t6<aiy::coin::Coin<aiy::aiy::AIY>>(Gas)
