...
module test::m1 {
    ...
    public fun transfer_(v: vector<coin::Coin<aiy::aiy::AIY>>, r: address) {
        v.do!(|c| {
...
//# run aiy::pay::split_and_transfer --type-args aiy::aiy::AIY --args object(2,0) 1000 @A --sender A
...
//> 0: test::m1::ret_one_amount();
//> 1: SplitCoins(Input(0), [Result(0), Input(1)]);
//> 2: MakeMoveVec<aiy::coin::Coin<aiy::aiy::AIY>>([NestedResult(1,0), NestedResult(1,1)]);
