...
module t2::o2 {
    ...
    public fun pop_coin(mut o2: vector<Coin<AIY>>): Coin<AIY> {
    ...
    public fun share_coin(o2: Coin<AIY>) {
...
//> 2: SplitCoins(Result(1), [Input(0)]);
//> 3: TransferObjects([Result(2)], Input(2));
//> 4: aiy::transfer::public_share_object<aiy::coin::Coin<aiy::aiy::AIY>>(Input(1));
