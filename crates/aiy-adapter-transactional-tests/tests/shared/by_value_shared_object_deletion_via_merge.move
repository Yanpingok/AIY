...
module t2::o2 {
    ...
    public fun mint_shared_coin(ctx: &mut TxContext) {
        transfer::public_share_object(coin::zero<AIY>(ctx))
    }
    ...
    public fun mint_owned_coin(ctx: &mut TxContext) {
        transfer::public_transfer(coin::zero<AIY>(ctx), @A)
    }

    public fun deleter(o2: Coin<AIY>) {
        coin::destroy_zero(o2);
    }

    public fun freezer(o2: Coin<AIY>) {
        transfer::public_freeze_object(o2);
    }

    public fun dofer(parent: &mut Obj2, o2: Coin<AIY>) {
        dof::add(&mut parent.id, 0, o2);
    }

    public fun dfer(parent: &mut Obj2, o2: Coin<AIY>) {
        df::add(&mut parent.id, 0, o2);
    }

    public fun transferer(o2: Coin<AIY>) {
        transfer::public_transfer(o2, @0x0);
    }

    public fun sharer(o2: Coin<AIY>) {
