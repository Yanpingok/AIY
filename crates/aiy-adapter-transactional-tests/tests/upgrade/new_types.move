...
module Test_DepV1::DepM1 {
    ...
    public struct DepObj has key, store { id: aiy::object::UID, v: u64 }

    public fun foo(ctx: &mut aiy::tx_context::TxContext) {
        aiy::transfer::share_object(DepObj { id: aiy::object::new(ctx), v: 42 });
    }
...
module Test_DepV2::DepM1 {
    ...
    public fun foo(ctx: &mut aiy::tx_context::TxContext) {
        aiy::transfer::share_object(DepObj { id: aiy::object::new(ctx), v: 7 });
    }
...
module Test_V1::M1 {
    ...
    public entry fun bar(ctx: &mut aiy::tx_context::TxContext) {
        DepM1::foo(ctx);
    }
