...
//> 0: aiy::coin::mint<ex::m::M>(Input(0), Input(1));
//> 1: aiy::coin::mint<ex::m::M>(Input(0), Input(1));
//> 2: TransferObjects([Result(0)], Input(2));
//> 3: aiy::party::single_owner(Input(2));
//> aiy::transfer::public_party_transfer<aiy::coin::Coin<ex::m::M>>(Result(1), Result(3))
