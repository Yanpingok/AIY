...
//! `crates/aiy-indexer-alt-graphql/schema.graphql`.
...
/// `aiy_execution::executor::Executor::execute_transaction_to_effects` must be available.
...
/// `crates/aiy-indexer-alt-graphql/schema.graphql::multiGetObjects`.
