...
use aiy_json_rpc_types::{DynamicFieldInfo as DynamicFieldInfoResponse, Page, AiyObjectResponse};
use aiy_open_rpc::Module;
use aiy_open_rpc_macros::open_rpc;
use aiy_types::{base_types::ObjectID, dynamic_field::DynamicFieldName};
...
#[open_rpc(namespace = "aiyx", tag = "Dynamic Fields API")]
