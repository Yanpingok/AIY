...
use aiy_indexer_alt_reader::tx_digests::TxDigestKey;
use aiy_indexer_alt_schema::schema::{
    tx_affected_addresses, tx_affected_objects, tx_calls, tx_digests,
};
use aiy_indexer_alt_schema::transactions::StoredTxDigest;
use aiy_json_rpc_types::{Page as PageResponse, AiyTransactionBlockResponseOptions};
use aiy_sql_macro::sql;
use aiy_types::{
    base_types::{ObjectID, AiyAddress},
    digests::TransactionDigest,
    messages_checkpoint::CheckpointSequenceNumber,
    aiy_serde::{BigInt, Readable},
};
...
pub(crate) struct AiyTransactionBlockResponseQuery {
