...
use aiy_json_rpc_types::{Page, AiyTransactionBlockResponse, AiyTransactionBlockResponseOptions};
use aiy_open_rpc::Module;
use aiy_open_rpc_macros::open_rpc;
use aiy_types::digests::TransactionDigest;

use self::{error::Error, filter::AiyTransactionBlockResponseQuery};
...
#[open_rpc(namespace = "aiy", tag = "Transactions API")]
...
#[open_rpc(namespace = "aiyx", tag = "Query Transactions API")]
...
trait QueryTransactionsApi {
    ...
    ) -> RpcResult<Page<AiyTransactionBlockResponse, String>>;
}
