...
use aiy_json_rpc_types::{
    DryRunTransactionBlockResponse, AiyTransactionBlockResponse, AiyTransactionBlockResponseOptions,
};
...
#[open_rpc(namespace = "aiy", tag = "Write API")]
...
pub trait WriteApi {
    ...
    async fn execute_transaction_block(
        ...
        /// The request type, derived from `AiyTransactionBlockResponseOptions` if None
