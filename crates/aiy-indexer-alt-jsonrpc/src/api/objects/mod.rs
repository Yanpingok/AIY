...
use filter::AiyObjectResponseQuery;
use futures::future;
use jsonrpsee::{core::RpcResult, proc_macros::rpc};
use aiy_json_rpc_types::{
    Page, AiyGetPastObjectRequest, AiyObjectDataOptions, AiyObjectResponse, AiyPastObjectResponse,
};
...
#[open_rpc(namespace = "aiy", tag = "Objects API")]
...
#[open_rpc(namespace = "aiyx", tag = "Query Objects API")]
...
trait QueryObjectsApi {
    ...
    async fn get_owned_objects(
        ...
        limit: Option<usize>,
    ) -> RpcResult<Page<AiyObjectResponse, String>>;
}
