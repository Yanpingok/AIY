...
use aiy_json_rpc_types::{Page as PageResponse, AiyObjectDataOptions};
...
use aiy_types::{
    ...
    aiy_serde::AiyStructTag,
    Identifier, TypeTag, AIY_FRAMEWORK_ADDRESS,
};
...
pub(crate) struct AiyObjectResponseQuery {
...
pub(crate) enum AiyObjectDataFilter {
...
/// [AiyObjectDataFilter] converted into fields that can be compared directly with values coming
/// from the database.
enum RawFilter {
...
/// all point to `aiy::dynamic_field::Field<K, V>` objects. Returns the IDs and a cursor pointing
...
pub(crate) async fn dynamic_fields(
    ...
    by_type_indices(
        ...
        &Some(AiyObjectDataFilter::StructType(StructTag {
