...
pub use aiy_name_service::NameServiceConfig;
...
pub struct RpcConfig {
    ...
    /// Configuration for AiyNS related RPC methods.
    ...
    pub package_resolver: aiy_package_resolver::Limits,
}
...
pub struct NameServiceLayer {
    pub package_address: Option<AiyAddress>,
...
impl RpcLayer {
    /// Generate an example configuration, aiytable for demonstrating the fields available to
    /// configure.
    pub fn example() -> Self {
        Self {
...
impl PackageResolverLayer {
    pub fn finish(self) -> aiy_package_resolver::Limits {
...
impl Default for NodeConfig {
    fn default() -> Self {
        Self {
            header_value: "aiy-indexer-alt-jsonrpc".to_string(),
