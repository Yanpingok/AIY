...
use aiy_rpc::proto::aiy::rpc::v2beta2::ProtocolConfig as RpcProtocolConfig;
use aiy_rpc::proto::aiy::rpc::v2beta2::{GetEpochRequest, GetEpochResponse};
use aiy_rpc_api::{
...
pub async fn get_epoch(
    ...
    chain: Chain,
) -> aiy_rpc_api::Result<GetEpochResponse> {
    let read_mask = {
