...
use std::sync::Arc;
use aiy_kv_rpc::KvRpcServer;
use aiy_rpc::proto::aiy::rpc::v2beta2::ledger_service_server::LedgerServiceServer;
use aiy_rpc_api::{RpcMetrics, RpcMetricsMakeCallbackHandler, ServerVersion};
...
async fn main() -> Result<()> {
    ...
    let server_version = Some(ServerVersion::new("aiy-kv-rpc", VERSION));
    ...
    let reflection_v1 = tonic_reflection::server::Builder::configure()
        .register_encoded_file_descriptor_set(
            aiy_rpc_api::proto::google::protobuf::FILE_DESCRIPTOR_SET,
        )
        .register_encoded_file_descriptor_set(aiy_rpc_api::proto::google::rpc::FILE_DESCRIPTOR_SET)
        .register_encoded_file_descriptor_set(aiy_rpc::proto::aiy::rpc::v2::FILE_DESCRIPTOR_SET)
        .register_encoded_file_descriptor_set(
    ...
    builder
        ...
        .add_service(
            aiy_rpc::proto::aiy::rpc::v2::ledger_service_server::LedgerServiceServer::new(server),
        )
