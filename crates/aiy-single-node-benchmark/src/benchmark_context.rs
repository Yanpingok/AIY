...
use aiy_core::authority::shared_object_version_manager::{AssignedTxAndVersions, AssignedVersions};
use aiy_core::mock_checkpoint_builder::ValidatorKeypairProvider;
use aiy_test_transaction_builder::PublishData;
...
pub struct BenchmarkContext {
    ...
    user_accounts: BTreeMap<AiyAddress, Account>,
