...
use clap::Parser;
use aiy_single_node_benchmark::command::Command;
use aiy_single_node_benchmark::run_benchmark;
use aiy_single_node_benchmark::workload::Workload;

#[tokio::main]
async fn main() {
    let _guard = telemetry_subscribers::TelemetryConfig::new()
        .with_log_level("off,aiy_single_node_benchmark=info")
        .with_env()
        .init();
