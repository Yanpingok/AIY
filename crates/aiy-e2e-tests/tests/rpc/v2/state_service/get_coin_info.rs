...
use aiy_rpc::proto::aiy::rpc::v2::coin_metadata::MetadataCapState;
use aiy_rpc::proto::aiy::rpc::v2::coin_treasury::SupplyState;
use aiy_rpc::proto::aiy::rpc::v2::regulated_coin_metadata::CoinRegulatedState;
use aiy_rpc::proto::aiy::rpc::v2::state_service_client::StateServiceClient;
...
async fn publish_non_otw_coin(
    ...
    let registry_obj_response = {
        ...
        use aiy_rpc::proto::aiy::rpc::v2::GetObjectRequest;
        ledger_client
            .get_object({
    ...
    use aiy_rpc::proto::aiy::rpc::v2::owner::OwnerKind;
    let registry_initial_version = registry_obj_response
        ...
        .and_then(|owner| {
            if owner.kind == Some(OwnerKind::Shared as i32) {
                owner
                    .version
                    .map(aiy_types::base_types::SequenceNumber::from)
            } else {
                None
            }
        })
...
async fn finalize_registration(
    ...
    use aiy_rpc::proto::aiy::rpc::v2::ledger_service_client::LedgerServiceClient;
    use aiy_rpc::proto::aiy::rpc::v2::owner::OwnerKind;
    use aiy_rpc::proto::aiy::rpc::v2::{GetObjectRequest, ListOwnedObjectsRequest};
    ...
    let mut client = aiy_rpc::client::v2::Client::new(test_cluster.rpc_url().to_owned()).unwrap();
