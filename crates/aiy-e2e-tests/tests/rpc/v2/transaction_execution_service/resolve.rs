...
use aiy_rpc::proto::aiy::rpc::v2::Argument;
use aiy_rpc::proto::aiy::rpc::v2::Bcs;
use aiy_rpc::proto::aiy::rpc::v2::Command;
use aiy_rpc::proto::aiy::rpc::v2::ExecuteTransactionRequest;
use aiy_rpc::proto::aiy::rpc::v2::GasPayment;
use aiy_rpc::proto::aiy::rpc::v2::Input;
use aiy_rpc::proto::aiy::rpc::v2::MoveCall;
use aiy_rpc::proto::aiy::rpc::v2::ObjectReference;
use aiy_rpc::proto::aiy::rpc::v2::ProgrammableTransaction;
use aiy_rpc::proto::aiy::rpc::v2::SimulateTransactionRequest;
use aiy_rpc::proto::aiy::rpc::v2::Transaction;
use aiy_rpc::proto::aiy::rpc::v2::TransactionKind;
use aiy_rpc::proto::aiy::rpc::v2::TransferObjects;
...
use aiy_types::transaction::Command as AiyCommand;
use aiy_types::transaction::{ObjectArg, TransactionData, TransactionDataAPI};
use test_cluster::TestClusterBuilder;

fn proto_to_response(
    proto: aiy_rpc::proto::aiy::rpc::v2::SimulateTransactionResponse,
) -> (
...
async fn resolve_transaction_insufficient_gas_with_payment_objects() {
    ...
    let mut client = aiy_rpc::client::v2::Client::new(test_cluster.rpc_url()).unwrap();

    let mut transaction = aiy_rpc::proto::aiy::rpc::v2::Transaction::default();
