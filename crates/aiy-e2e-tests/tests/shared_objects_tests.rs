...
use aiy_macros::{register_fail_point_async, sim_test};
...
use aiy_types::execution_status::{CommandArgumentError, ExecutionFailureStatus, ExecutionStatus};
use aiy_types::messages_grpc::{LayoutGenerationOption, ObjectInfoRequest};
use aiy_types::transaction::{CallArg, ObjectArg};
use test_cluster::TestClusterBuilder;
use tokio::time::sleep;

/// Send a simple shared object transaction to Aiy and ensures the client gets back a response.
#[sim_test]
...
/// End-to-end shared transaction test for a Aiy validator. It does not test the client or wallet,
/// but tests the end-to-end flow from Aiy to consensus.
#[sim_test]
