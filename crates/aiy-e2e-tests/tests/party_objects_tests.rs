...
use aiy_test_transaction_builder::publish_basics_package_and_make_party_object;
use aiy_types::base_types::{FullObjectRef, AiyAddress};
...
async fn party_object_transfer_multi_certs() {
    ...
    aiy_macros::register_fail_point_async("transaction_execution_delay", move || async move {
        let delay = {
...
async fn party_object_grpc() {
    ...
    use aiy_rpc::proto::aiy::rpc::v2beta2::ledger_service_client::LedgerServiceClient;
    use aiy_rpc::proto::aiy::rpc::v2beta2::live_data_service_client::LiveDataServiceClient;
    use aiy_rpc::proto::aiy::rpc::v2beta2::owner::OwnerKind;
    use aiy_rpc::proto::aiy::rpc::v2beta2::GetObjectRequest;
    use aiy_rpc::proto::aiy::rpc::v2beta2::ListOwnedObjectsRequest;
    ...
    assert_eq!(new_owner.address, Some(AiyAddress::ZERO.to_string()));
...
async fn party_coin_grpc() {
    ...
    use aiy_types::transaction::{CallArg, ObjectArg, TransactionData};
    ...
    builder.programmable_move_call(
        ...
        vec!["0x2::coin::Coin<0x2::aiy::AIY>".parse().unwrap()],
    ...
    let kind = aiy_types::transaction::TransactionKind::ProgrammableTransaction(ptb);
...
async fn party_object_jsonrpc() {
    ...
    let client = test_cluster.aiy_client();

    let object = client
        .read_api()
        .get_object_with_options(
            object_id,
            aiy_json_rpc_types::AiyObjectDataOptions::new().with_owner(),
        )
        .await
        .unwrap()
        .data
    ...
    assert_eq!(new_owner_address, AiyAddress::ZERO);
