...
use aiy_types::base_types::{ObjectID, ObjectRef, SequenceNumber};
...
use aiy_types::object::{Owner, OBJECT_START_VERSION};
...
async fn objects_transitioning_to_shared_remember_their_previous_version() {
    ...
    assert_eq!(location.module.address(), &AIY_FRAMEWORK_ADDRESS);
