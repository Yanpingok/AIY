...
module aiy_system::aiy_system_state_inner {
    ...
    public(package) fun create(
        ...
        let mut system_state = AiySystemStateInner {
            epoch: 0,
            protocol_version,
    ...
    public(package) fun protocol_version(self: &AiySystemStateInner): u64 { self.protocol_version }
    public(package) fun system_state_version(self: &AiySystemStateInner): u64 { self.system_state_version }
    public(package) fun genesis_system_state_version(): u64 {
        SYSTEM_STATE_VERSION_V1
    }

    public(package) fun add_dummy_inactive_validator_for_testing(self: &mut AiySystemStateInner, ctx: &mut TxContext) {
    ...
    public(package) fun store_execution_time_estimates(self: &mut AiySystemStateInner, estimates: vector<u8>) {
