...
module aiy_system::aiy_system_state_inner {
    ...
    use aiy_system::validator::{Validator, ValidatorV2};
    use aiy_system::validator_wrapper::ValidatorWrapper;
    use aiy_system::validator_wrapper;
    use aiy::object;
    use aiy_system::validator;
    ...
    public(package) fun protocol_version(self: &AiySystemStateInnerV2): u64 { self.protocol_version }
    public(package) fun system_state_version(self: &AiySystemStateInnerV2): u64 { self.system_state_version }
    ...
    public(package) fun v1_to_v2(v1: AiySystemStateInner): AiySystemStateInnerV2 {
    ...
    fun touch_dummy_inactive_validator(self: &mut AiySystemStateInnerV2) {
    ...
    public(package) fun store_execution_time_estimates(self: &mut AiySystemStateInnerV2, estimates: vector<u8>) {
