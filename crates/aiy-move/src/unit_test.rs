...
use aiy_move_build::{decorate_warnings, implicit_deps};
use aiy_move_natives::{
    ...
    pub fn execute(
        ...
        if !cfg!(feature = "tracing") && compute_coverage {
            return Err(anyhow::anyhow!(
                ...
                Please build the Aiy CLI from source with `--features tracing` to use this flag."
            ));
        }
