...
//# run-jsonrpc
{
  "method": "aiyx_getLatestAiySystemState",
  "params": []
}

//# programmable --sender A --inputs 1000000000 object(0x5) @validator_0
//> 0: SplitCoins(Gas, [Input(0)]);
//> 1: aiy_system::aiy_system::request_add_stake(Input(1), Result(0), Input(2))
...
//> 0: aiy_system::aiy_system::request_withdraw_stake(Input(0), Input(1))
