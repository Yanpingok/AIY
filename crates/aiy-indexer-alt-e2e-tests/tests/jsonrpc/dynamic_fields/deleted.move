...
//# run-jsonrpc
{
  "method": "aiyx_getDynamicFieldObject",
...
//# programmable --sender A --inputs object(1,0) 42
//> 0: aiy::bag::remove<u64, u64>(Input(0), Input(1))
...
//> 1: aiy::object_bag::add<u64, aiy::coin::Coin<aiy::aiy::AIY>>(Input(0), Input(1), Result(0))
...
//# programmable --sender A --inputs object(10,0) 43
//> 0: aiy::object_bag::remove<u64, aiy::coin::Coin<aiy::aiy::AIY>>(Input(0), Input(1));
