...
module P0::M {
  ...
  public fun foo() { aiy::event::emit(P0MFoo()) }
}
...
module P0::N {
  ...
  public fun bar() { aiy::event::emit(P0NBar()) }
  public fun baz() { aiy::event::emit(P0NBaz()) }
}
...
module P1::M {
  ...
  public fun qux() { aiy::event::emit(P1MQux()) }
}
...
//# run-jsonrpc
{
  "method": "aiyx_queryTransactionBlocks",
  "params": [
    {
      "filter": {
        "MoveFunction": {
