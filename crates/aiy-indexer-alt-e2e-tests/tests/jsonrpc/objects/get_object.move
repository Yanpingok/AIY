...
//> 0: aiy::table::new<u64, aiy::coin::Coin<aiy::aiy::AIY>>();
...
//> 0: aiy::table::add<u64, aiy::coin::Coin<aiy::aiy::AIY>>(Input(0), Input(1), Input(2));
...
//> 0: aiy::table::remove<u64, aiy::coin::Coin<aiy::aiy::AIY>>(Input(0), Input(1));
