  ...
  epoch(epochId: 0) {
    ...
    validatorSet {
      activeValidators {
        ...
        nodes {
          address
          balance(coinType: "0x2::aiy::AIY") {
            totalBalance
          }
          balances {
            __typename
          }
          # todo DVX-1697 populate defaultAiynsName
          defaultAiynsName
          multiGetBalances(keys: ["0x2::aiy::AIY"]) {
            totalBalance
          }
          objects {
            __typename
          ...
          stakingPoolAiyBalance
          # todo DVX-1697 populate rewardsPool
          rewardsPool
          poolTokenBalance
          # todo DVX-1697 populate pendingStake
          pendingStake
          # todo DVX-1697 populate pendingTotalAiyWithdraw
          pendingTotalAiyWithdraw
