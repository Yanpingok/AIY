...
//> 1: aiy::object::id_address<aiy::coin::Coin<aiy::aiy::AIY>>(Gas);
...
//> 1: aiy::object::id_address<aiy::coin::Coin<aiy::aiy::AIY>>(NestedResult(0,0));
//> 2: TransferObjects([NestedResult(0,1)], Result(1));
//> 3: aiy::object::id_address<aiy::coin::Coin<aiy::aiy::AIY>>(Gas);
...
{ # ... and for balance point-lookups
  object(address: "@{obj_0_0}", version: 2) {
    balance(coinType: "0x2::aiy::AIY") { totalBalance }
  }
}
...
{ # ... and balance multi-gets
  object(address: "@{obj_0_0}", version: 2) {
    multiGetBalances(keys: ["0x2::aiy::AIY"]) { totalBalance }
  }
}
...
fragment Owned on IAddressable {
  ...
  aiy: balance(coinType: "0x2::aiy::AIY") { totalBalance }
