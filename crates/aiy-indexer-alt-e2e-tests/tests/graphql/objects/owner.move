...
//> 0: aiy::bag::add<u64, u64>(Input(0), Input(1), Input(1))

//# programmable --sender A --inputs 2000
//> 0: SplitCoins(Gas, [Input(0)]);
//> 1: aiy::transfer::public_share_object<aiy::coin::Coin<aiy::aiy::AIY>>(Result(0));

//# programmable --sender A --inputs 3000
//> 0: SplitCoins(Gas, [Input(0)]);
//> 1: aiy::transfer::public_freeze_object<aiy::coin::Coin<aiy::aiy::AIY>>(Result(0));

//# programmable --sender A --inputs 4000 @A
//> 0: SplitCoins(Gas, [Input(0)]);
//> 1: aiy::party::single_owner(Input(1));
//> 2: aiy::transfer::public_party_transfer<aiy::coin::Coin<aiy::aiy::AIY>>(Result(0), Result(1));
