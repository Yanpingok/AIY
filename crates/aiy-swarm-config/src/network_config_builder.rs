...
use rand::rngs::OsRng;
use aiy_config::genesis::{TokenAllocation, TokenDistributionScheduleBuilder};
use aiy_config::node::AuthorityOverloadConfig;
#[cfg(msim)]
use aiy_config::node::ExecutionTimeObserverConfig;
use aiy_config::ExecutionCacheConfig;
use aiy_protocol_config::Chain;
use aiy_types::base_types::{AuthorityName, AiyAddress};
use aiy_types::committee::{Committee, ProtocolVersion};
    ...
    pub fn build(self) -> NetworkConfig {
        ...
        let token_distribution_schedule = {
            ...
            for validator in &validators {
                ...
                let address = AiyAddress::from(&account_key);
        ...
        let genesis = {
            let mut builder = aiy_genesis_builder::Builder::new()
...
mod test {
    ...
    fn genesis_transaction() {
        ...
        let genesis = network_config.genesis;
        let protocol_version = ProtocolVersion::new(genesis.aiy_system_object().protocol_version());
