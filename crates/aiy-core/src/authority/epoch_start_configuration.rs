...
use aiy_types::accumulator_root::get_accumulator_root_obj_initial_shared_version;

use std::fmt;
use aiy_types::authenticator_state::get_authenticator_state_obj_initial_shared_version;
use aiy_types::base_types::SequenceNumber;
use aiy_types::bridge::{get_bridge_obj_initial_shared_version, is_bridge_committee_initiated};
use aiy_types::coin_registry::get_coin_registry_obj_initial_shared_version;
use aiy_types::deny_list_v1::get_deny_list_obj_initial_shared_version;
use aiy_types::epoch_data::EpochData;
use aiy_types::error::AiyResult;
use aiy_types::messages_checkpoint::{CheckpointDigest, CheckpointTimestamp};
...
impl EpochFlag {
    ...
    fn default_flags_impl() -> Vec<Self> {
        ...
        if std::env::var("AIY_USE_NEW_COMMIT_HANDLER").is_ok() || in_test_configuration() {
