...
use aiy_types::transaction::{TransactionDataAPI, TransactionKind};

use aiy_config::node::{CheckpointExecutorConfig, RunWithRange};
...
impl CheckpointExecutor {
    ...
    pub async fn run_epoch(self, run_with_range: Option<RunWithRange>) -> StopReason {
        ...
        let concurrency = std::env::var("AIY_CHECKPOINT_EXECUTION_MAX_CONCURRENCY")
            .ok()
