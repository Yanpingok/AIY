...
use aiy_json_rpc_types::{
    EffectsWithInput, EventFilter, AiyTransactionBlockEffects, AiyTransactionBlockEvents,
    TransactionFilter,
};
use aiy_json_rpc_types::{AiyEvent, AiyTransactionBlockEffectsAPI};
...
pub struct SubscriptionHandler {
    event_streamer: Streamer<AiyEvent, AiyEvent, EventFilter>,
    transaction_streamer: Streamer<EffectsWithInput, AiyTransactionBlockEffects, TransactionFilter>,
}
...
impl SubscriptionHandler {
    ...
    pub fn subscribe_events(&self, filter: EventFilter) -> impl Stream<Item = AiyEvent> {
    ...
    ) -> impl Stream<Item = AiyTransactionBlockEffects> {
