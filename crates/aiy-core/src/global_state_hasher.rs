...
use aiy_types::base_types::{ObjectID, ObjectRef, SequenceNumber, VersionNumber};
...
use aiy_types::storage::{ObjectKey, ObjectStore};
use tracing::debug;
...
use aiy_types::messages_checkpoint::{CheckpointSequenceNumber, ECMHLiveObjectSetDigest};
...
impl GlobalStateHasher {
    ...
    ) -> AiyResult<ECMHLiveObjectSetDigest> {
        Ok(self
