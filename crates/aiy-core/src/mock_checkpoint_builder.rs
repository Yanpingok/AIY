...
use std::mem;
use aiy_types::base_types::{AuthorityName, VerifiedExecutionData};
use aiy_types::committee::Committee;
use aiy_types::crypto::{AuthoritySignInfo, AuthoritySignature, AiyAuthoritySignature};
...
use aiy_types::transaction::{Transaction, VerifiedTransaction};
        ...
        let signatures = validator_keys
            ...
            .map(|(name, _)| {
                let intent_msg = shared_crypto::intent::IntentMessage::new(
                    shared_crypto::intent::Intent::aiy_app(
