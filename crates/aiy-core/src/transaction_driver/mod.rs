...
pub struct QuorumTransactionResponse {
    ...
    pub effects: aiy_types::quorum_driver_types::FinalizedEffects,

    pub events: Option<aiy_types::effects::TransactionEvents>,
    // Input objects will only be populated in the happy path
    pub input_objects: Option<Vec<aiy_types::object::Object>>,
    // Output objects will only be populated in the happy path
    pub output_objects: Option<Vec<aiy_types::object::Object>>,
...
pub fn choose_transaction_driver_percentage(
    chain_id: Option<aiy_types::digests::ChainIdentifier>,
) -> u8 {
    ...
    if let Some(chain_identifier) = chain_id {
        if chain_identifier.chain() == aiy_protocol_config::Chain::Mainnet {
