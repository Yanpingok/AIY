...
use crate::authority::authority_store::{
    ExecutionLockWriteGuard, LockDetailsDeprecated, ObjectLockStatus, AiyLockResult,
};
...
use aiy_types::bridge::{get_bridge, Bridge};
use aiy_types::digests::{ObjectDigest, TransactionDigest, TransactionEffectsDigest};
...
use aiy_types::transaction::{TransactionDataAPI, VerifiedSignedTransaction, VerifiedTransaction};
use tap::TapOptional;
...
impl ObjectCacheRead for WritebackCache {
    ...
    fn get_lock(&self, obj_ref: ObjectRef, epoch_store: &AuthorityPerEpochStore) -> AiyLockResult {
        ...
        match self.get_object_by_id_cache_only("lock", &obj_ref.0) {
            ...
            CacheResult::NegativeHit => {
                Err(AiyError::from(UserInputError::ObjectNotFound {
                    object_id: obj_ref.0,
