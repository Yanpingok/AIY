...
use aiy_types::base_types::{random_object_ref, FullObjectRef, ObjectID};
use aiy_types::crypto::AuthorityKeyPair;
use aiy_types::crypto::{AccountKeyPair, AuthorityPublicKeyBytes, Signer};
use aiy_types::effects::{SignedTransactionEffects, TestEffectsBuilder};
...
use aiy_types::{
    base_types::{AuthorityName, ExecutionDigests, ObjectRef, AiyAddress, TransactionDigest},
    committee::Committee,
...
) -> Result<(CertifiedTransaction, SignedTransactionEffects), AiyError> {
...
pub fn make_transfer_aiy_transaction(
...
pub fn make_pay_aiy_transaction(
    gas_object: ObjectRef,
    coins: Vec<ObjectRef>,
    ...
    let data = TransactionData::new_pay_aiy(
