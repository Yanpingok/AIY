...
impl MetricsPushClient {
    pub fn new(metrics_key: aiy_types::crypto::NetworkKeyPair) -> Self {
        use fastcrypto::traits::KeyPair;
        let certificate = std::sync::Arc::new(aiy_tls::SelfSignedCertificate::new(
            metrics_key.private(),
            aiy_tls::AIY_VALIDATOR_SERVER_NAME,
        ));
