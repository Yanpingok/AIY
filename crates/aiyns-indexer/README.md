...
This indexer is used to cache the on-chain state of the AiyNS registry to a database,
...
- `BACKFILL_PROGRESS_FILE_PATH`: Expects a file in the format `{ "aiyns_indexing": <starting_checkpoint> }`
