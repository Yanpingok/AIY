...
use aiy_types::aiy_system_state::aiy_system_state_inner_v1::SystemParametersV1;
use aiy_types::aiy_system_state::aiy_system_state_inner_v2::SystemParametersV2;
