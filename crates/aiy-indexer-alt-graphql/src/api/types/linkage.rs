...
use crate::api::scalars::aiy_address::AiyAddress;
use crate::api::scalars::uint53::UInt53;
use async_graphql::Object;
use aiy_types::base_types::ObjectID;
use aiy_types::move_package::UpgradeInfo;
...
impl Linkage<'_> {
    ...
    pub(crate) async fn original_id(&self) -> Option<AiyAddress> {
        Some((*self.object_id).into())
    }

    /// The ID on-chain of the version of the dependency that this package depends on.
    pub(crate) async fn upgraded_id(&self) -> Option<AiyAddress> {
