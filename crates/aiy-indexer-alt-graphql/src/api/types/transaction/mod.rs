...
use aiy_types::{
    base_types::AiyAddress as NativeAiyAddress,
...
/// Description of a transaction, the unit of activity on Aiy.
#[Object]
impl Transaction {
...
impl TransactionContents {
    ...
    async fn sender(&self) -> Result<Option<Address>, RpcError> {
        ...
        Ok((sender != NativeAiyAddress::ZERO)
...
async fn tx_affected_address(
    ...
    mut query: Query<'_>,
    page: &Page<CTransaction>,
    affected_address: AiyAddress,
    sent_address: Option<AiyAddress>,
