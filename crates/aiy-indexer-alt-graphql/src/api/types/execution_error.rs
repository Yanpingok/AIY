...
use std::fmt::Write;
use aiy_package_resolver::{CleverError, ErrorConstants};
use aiy_types::{
    execution_status::{
...
impl ExecutionError {
    ...
    ///
    /// Since protocol version 48, the Aiy protocol layer automatically resolves module ID, which makes
...
async fn resolve_module_id_for_move_abort(
    ...
    use aiy_types::execution_status::MoveLocationOpt;
        ...
        .await
    {
        ...
        Err(aiy_package_resolver::error::Error::LinkageNotFound(_)) => {
