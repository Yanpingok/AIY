...
use aiy_types::aiy_system_state::aiy_system_state_inner_v1::ValidatorSetV1;

use crate::{
    api::{
        scalars::{big_int::BigInt, cursor::JsonCursor, aiy_address::AiyAddress},
...
impl ValidatorSet {
    ...
    async fn active_validators(
        ...
        page.paginate_indices(self.native.active_validators.len(), |i| {
            ...
            let at_risk = self
                .native
                .at_risk_validators
                .get(&validator.metadata.aiy_address)
    ...
    async fn inactive_pools_id(&self) -> Option<AiyAddress> {
    ...
    async fn pending_active_validators_id(&self) -> Option<AiyAddress> {
    ...
    async fn staking_pool_mappings_id(&self) -> Option<AiyAddress> {
    ...
    async fn validator_candidates_id(&self) -> Option<AiyAddress> {
