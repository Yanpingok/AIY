...
use aiy_indexer_alt_reader::pg_reader::PgReader;
use aiy_sql_macro::query;
use aiy_types::{
    base_types::AiyAddress as NativeAiyAddress, digests::TransactionDigest,
...
impl Event {
    ...
    /// The Base64 encoded BCS serialized bytes of the entire Event structure from aiy-types.
