...
use aiy_indexer_alt_reader::package_resolver::PackageCache;
use aiy_package_resolver::{error::Error as PackageResolverError, Package, PackageStore, Resolver};
use aiy_types::{
...
pub(crate) struct Scope {
    ...
    resolver_limits: aiy_package_resolver::Limits,
}
