...
use aiy_json_rpc_types::{
    AiyTransactionBlockEffects, AiyTransactionBlockEvents, AiyTransactionBlockResponse,
};
...
impl TryFrom<AiyTransactionBlockResponse> for RetrievedTransaction {
    type Error = anyhow::Error;
    fn try_from(response: AiyTransactionBlockResponse) -> Result<Self, Self::Error> {
