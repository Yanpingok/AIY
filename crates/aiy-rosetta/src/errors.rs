...
use crate::types::{BlockHash, OperationType, PublicKey, AiyEnv};
...
/// Aiy-Rosetta specific error types.
/// This contains all the errors returns by the aiy-rosetta server.
...
pub enum Error {
    ...
    #[error(transparent)]
    AiyRpcError(#[from] aiy_sdk::error::Error),
    #[error(transparent)]
