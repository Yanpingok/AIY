...
use aiy_sdk::rpc_types::StakeStatus;
...
use aiy_sdk::error::AiyRpcResult;
...
async fn get_checkpoint(ctx: &OnlineServerContext) -> AiyRpcResult<CheckpointSequenceNumber> {
    ctx.client
        .read_api()
