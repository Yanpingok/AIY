...
use aiy_rosetta::types::{
    ...
    PreprocessMetadata, Signature, SignatureType, SubAccount, SubAccountType, AiyEnv,
    TransactionIdentifierResponse,
};
use aiy_rosetta::{RosettaOfflineServer, RosettaOnlineServer};
use aiy_sdk::AiyClient;
use aiy_types::base_types::AiyAddress;
use aiy_types::crypto::AiySignature;

pub async fn start_rosetta_test_server(client: AiyClient) -> (RosettaClient, Vec<JoinHandle<()>>) {
    let online_server = RosettaOnlineServer::new(AiyEnv::LocalNet, client);
    let offline_server = RosettaOfflineServer::new(AiyEnv::LocalNet);
            ...
            .call(
                ...
                &ConstructionCombineRequest {
                    ...
                    signatures: vec![Signature {
                        ...
                        hex_bytes: Hex::from_bytes(AiySignature::signature_bytes(&signature)),
                    }],
                },
            )
            .await;
