...
use aiy_rosetta::types::{
    ...
    NetworkIdentifier, PreprocessMetadata, Signature, SignatureType, AiyEnv,
...
async fn pay_with_gas_budget(budget: u64) -> TransactionIdentifierResponseResult {
    ...
    let ops: Operations = serde_json::from_value(json!(
        [{
            ...
            "amount" : { "value": "1000000000" , "currency": { "symbol": "AIY", "decimals": 9}}
        },{
            ...
            "amount" : {
                "value": "-1000000000",
                "currency": { "symbol": "AIY", "decimals": 9,
                }
            },
        }]
    ))
