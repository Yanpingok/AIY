...
use reqwest::Client;
use aiy_edge_proxy::config::{load, ProxyConfig};
use aiy_edge_proxy::handlers::{proxy_handler, AppState};
use aiy_edge_proxy::metrics::AppMetrics;
use tracing::info;
...
struct Args {
    #[clap(
        long,
        short,
        default_value = "./aiy-edge-proxy.yaml",
