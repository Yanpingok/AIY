...
use aiy_core::traffic_controller::{parse_ip, policies::TrafficTally, TrafficController};
use aiy_json_rpc_api::TRANSACTION_EXECUTION_CLIENT_ERROR_CODE;
use aiy_types::traffic_control::ClientIdSource;
use aiy_types::traffic_control::Weight;
use tracing::error;
...
async fn handle_traffic_resp(
    ...
    traffic_controller.tally(TrafficTally {
        ...
        // such as `aiy_executeTransactionBlock`, as this can enable
        // node operators who wish to rate limit their transcation
        // traffic and incentivize high volume clients to choose a
        // aiytable rpc provider (or run their own). Later we may want
