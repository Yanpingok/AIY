...
use aiy_json_rpc_api::{BridgeReadApiOpenRpc, BridgeReadApiServer, JsonRpcMetrics};
use aiy_open_rpc::Module;
use aiy_types::bridge::{get_bridge_obj_initial_shared_version, BridgeSummary, BridgeTrait};
...
impl AiyRpcModule for BridgeReadApi {
