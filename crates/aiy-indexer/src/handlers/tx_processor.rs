...
use aiy_json_rpc::get_balance_changes_from_effect;
use aiy_json_rpc::get_object_changes;
use aiy_json_rpc::ObjectProvider;
...
impl TxChangesProcessor {
    ...
    pub(crate) async fn get_changes(
        ...
        Vec<aiy_json_rpc_types::BalanceChange>,
...
// This is a struct that is used to extract AiySystemState and its dynamic children
...
impl aiy_types::storage::ObjectStore for EpochEndIndexingObjectStore<'_> {
