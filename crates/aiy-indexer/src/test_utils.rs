...
#[derive(Clone)]
pub struct AiyTransactionBlockResponseBuilder<'a> {
    response: AiyTransactionBlockResponse,
    full_response: &'a AiyTransactionBlockResponse,
}

impl<'a> AiyTransactionBlockResponseBuilder<'a> {
    pub fn new(full_response: &'a AiyTransactionBlockResponse) -> Self {
        Self {
            response: AiyTransactionBlockResponse::default(),
            full_response,
        }
    }

    pub fn with_input(mut self) -> Self {
        self.response = AiyTransactionBlockResponse {
    ...
    pub fn build(self) -> AiyTransactionBlockResponse {
...
pub async fn set_up(
    ...
    let server_handle = tokio::spawn(async move {
        aiy_rpc_api::RpcService::new(sim)
