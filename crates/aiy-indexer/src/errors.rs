...
use aiy_types::base_types::ObjectIDParseError;
use aiy_types::error::{AiyError, AiyObjectResponseError, UserInputError};
...
pub enum IndexerError {
    ...
    JsonRpcServerError(#[from] aiy_json_rpc::error::Error),
    ...
    #[error(transparent)]
    ObjectResponseError(#[from] AiyObjectResponseError),
