...
use aiy_json_rpc_types::{EndOfEpochInfo, EpochInfo};
use aiy_types::event::SystemEpochInfoEvent;
use aiy_types::messages_checkpoint::CertifiedCheckpointSummary;
...
impl StartOfEpochUpdate {
    pub fn new(
        new_system_state_summary: AiySystemStateSummary,
...
impl StoredEpochInfo {
    pub fn get_json_system_state_summary(&self) -> Result<AiySystemStateSummary, IndexerError> {
