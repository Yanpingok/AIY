...
impl TransactionSponsorship {
    pub fn select_gas(
        ...
        exec: &mut Executor,
        gas_coins: u32,
    ) -> (Vec<ObjectRef>, (u64, Object), AiyAddress) {
        match self {
...
impl AUTransactionGen for P2PTransferGenRandomGasRandomPriceRandomSponsorship {
    fn apply(
        ...
        // construct a p2p transfer of a random amount of AIY
        let txn = {
            let mut builder = ProgrammableTransactionBuilder::new();
            builder.transfer_aiy(recipient.initial_data.account.address, Some(self.amount));
            builder.finish()
        };
