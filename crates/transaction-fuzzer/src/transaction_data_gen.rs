...
pub fn gen_gas_data(sender: AiyAddress) -> impl Strategy<Value = GasData> {
    (
...
pub fn transaction_data_gen(sender: AiyAddress) -> impl Strategy<Value = TransactionData> {
...
{
    pub fn new(sender: AiyAddress) -> Self {
        Self {
            kind: None,
            sender,
            gas_data: None,
