...
use aiy_rpc::proto::aiy::rpc::v2::get_checkpoint_request::CheckpointId;
use aiy_rpc::proto::aiy::rpc::v2::Checkpoint;
                                ...
                                service
                                    ...
                                    .map(|info| {
                                        info.balance_changes
                                            .into_iter()
                                            .map(aiy_rpc::proto::aiy::rpc::v2::BalanceChange::from)
                                            .collect::<Vec<_>>()
                                    })
                            })
                            .flatten()
