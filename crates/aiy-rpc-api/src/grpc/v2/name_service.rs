...
use aiy_rpc::proto::aiy::rpc::v2::name_service_server::NameService;
use aiy_rpc::proto::aiy::rpc::v2::LookupNameRequest;
use aiy_rpc::proto::aiy::rpc::v2::LookupNameResponse;
use aiy_rpc::proto::aiy::rpc::v2::ReverseLookupNameRequest;
use aiy_rpc::proto::aiy::rpc::v2::ReverseLookupNameResponse;
...
fn lookup_name(service: &RpcService, request: LookupNameRequest) -> Result<LookupNameResponse> {
    ...
    if is_valid {
        let mut record = aiy_rpc::proto::aiy::rpc::v2::NameRecord::default();
