...
use aiy_rpc::proto::aiy::rpc::v2::subscription_service_server::SubscriptionService;
use aiy_rpc::proto::aiy::rpc::v2::Checkpoint;
use aiy_rpc::proto::aiy::rpc::v2::SubscribeCheckpointsRequest;
use aiy_rpc::proto::aiy::rpc::v2::SubscribeCheckpointsResponse;
