...
use aiy_rpc::proto::aiy::rpc::v2::dynamic_field::DynamicFieldKind;
use aiy_rpc::proto::aiy::rpc::v2::Bcs;
use aiy_rpc::proto::aiy::rpc::v2::DynamicField;
use aiy_rpc::proto::aiy::rpc::v2::ErrorReason;
...
fn load_dynamic_field(
    ...
    if read_mask.contains(DynamicField::NAME_FIELD) {
        message.name = Some(
            Bcs::default()
                .with_name(aiy_types::TypeTag::from(field.name_layout).to_canonical_string(true))
    ...
    if read_mask.contains(DynamicField::VALUE_FIELD) {
        message.value = Some(
            Bcs::default()
                .with_name(aiy_types::TypeTag::from(field.value_layout).to_canonical_string(true))
