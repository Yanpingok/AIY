...
use aiy_rpc::proto::aiy::rpc::v2::coin_treasury::SupplyState as RpcSupplyState;
use aiy_rpc::proto::aiy::rpc::v2::CoinTreasury;
...
use aiy_types::coin_registry::{Currency, RegulatedState as CurrencyRegulatedState, SupplyState};
use aiy_types::object::Owner::AddressOwner;
use aiy_types::object::Owner::ConsensusAddressOwner;
use aiy_types::object::Owner::Immutable;
...
fn get_treasury_cap_info(
    ...
    let supply_state = match &obj.owner {
        ...
        AddressOwner(addr) if *addr == AiyAddress::ZERO => RpcSupplyState::Fixed,
        ConsensusAddressOwner { owner, .. } if *owner == AiyAddress::ZERO => RpcSupplyState::Fixed,
