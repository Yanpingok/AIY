...
use aiy_rpc::proto::aiy::rpc::v2::transaction_execution_service_server::TransactionExecutionService;
...
pub async fn execute_transaction(
    ...
    let request = aiy_types::quorum_driver_types::ExecuteTransactionRequestV3 {
