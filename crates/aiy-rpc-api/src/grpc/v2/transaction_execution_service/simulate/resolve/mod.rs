...
fn resolve_unresolved_transaction(
    ...
    unresolved_inputs: &[aiy_rpc::proto::aiy::rpc::v2::Input],
    commands: Vec<Command>,
    gas_payment: Option<&aiy_rpc::proto::aiy::rpc::v2::GasPayment>,
    expiration: Option<&aiy_rpc::proto::aiy::rpc::v2::TransactionExpiration>,
) -> Result<TransactionData> {
...
fn resolve_arg(
    ...
    called_packages: &mut NormalizedPackages,
    commands: &[Command],
    arg: &aiy_rpc::proto::aiy::rpc::v2::Input,
    arg_idx: usize,
) -> Result<CallArg> {
    use aiy_rpc::proto::aiy::rpc::v2::input::InputKind;
...
impl TryFrom<&aiy_rpc::proto::aiy::rpc::v2::ObjectReference> for UnresolvedObjectReference {
    type Error = FieldViolation;

    fn try_from(
        value: &aiy_rpc::proto::aiy::rpc::v2::ObjectReference,
...
struct UnresolvedInput<'a> {
    pub kind: Option<aiy_rpc::proto::aiy::rpc::v2::input::InputKind>,
...
impl<'a> UnresolvedInput<'a> {
    fn from_proto(input: &'a aiy_rpc::proto::aiy::rpc::v2::Input) -> Result<Self, FieldViolation> {
        Ok(Self {
