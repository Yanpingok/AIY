...
use aiy_rpc::proto::aiy::rpc::v2::signature_verification_service_server::SignatureVerificationService;
use aiy_rpc::proto::aiy::rpc::v2::VerifySignatureRequest;
use aiy_rpc::proto::aiy::rpc::v2::VerifySignatureResponse;
