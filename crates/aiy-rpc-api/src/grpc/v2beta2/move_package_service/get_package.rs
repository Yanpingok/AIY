...
use aiy_rpc::proto::aiy::rpc::v2beta2::{GetPackageRequest, GetPackageResponse, Package};
...
pub fn get_package(service: &RpcService, request: GetPackageRequest) -> Result<GetPackageResponse> {
    ...
    let resolved_package =
        aiy_package_resolver::Package::read_from_package(&package).map_err(convert_error)?;
