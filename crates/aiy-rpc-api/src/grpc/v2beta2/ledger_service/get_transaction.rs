...
use aiy_rpc::proto::aiy::rpc::v2beta2::Event;
...
use aiy_rpc::proto::aiy::rpc::v2beta2::GetTransactionResult;
...
pub(crate) fn render_clever_error(service: &RpcService, effects: &mut TransactionEffects) {
    use aiy_rpc::proto::aiy::rpc::v2beta2::clever_error;
    use aiy_rpc::proto::aiy::rpc::v2beta2::execution_error::ErrorDetails;
    use aiy_rpc::proto::aiy::rpc::v2beta2::CleverError;
    use aiy_rpc::proto::aiy::rpc::v2beta2::MoveAbort;
