...
use aiy_name_service::Domain;
use aiy_name_service::NameRecord;
...
use aiy_rpc::proto::aiy::rpc::v2beta2::name_service_server::NameService;
use aiy_rpc::proto::aiy::rpc::v2beta2::LookupNameRequest;
use aiy_rpc::proto::aiy::rpc::v2beta2::LookupNameResponse;
use aiy_rpc::proto::aiy::rpc::v2beta2::ReverseLookupNameRequest;
use aiy_rpc::proto::aiy::rpc::v2beta2::ReverseLookupNameResponse;
...
fn name_service_config(service: &RpcService) -> Result<NameServiceConfig> {
    match service.chain_id.chain() {
        aiy_protocol_config::Chain::Mainnet => Ok(NameServiceConfig::mainnet()),
        aiy_protocol_config::Chain::Testnet => Ok(NameServiceConfig::testnet()),
        aiy_protocol_config::Chain::Unknown => Err(RpcError::new(
            tonic::Code::Unimplemented,
            "AiyNS not configured for this network",
        )),
    }
}
...
fn lookup_name(service: &RpcService, request: LookupNameRequest) -> Result<LookupNameResponse> {
    ...
    if is_valid {
        let mut record = aiy_rpc::proto::aiy::rpc::v2beta2::NameRecord::default();
...
fn reverse_lookup_name(
    ...
    let domain = field_reverse_record_object
        .to_rust::<aiy_types::dynamic_field::Field<Address, Domain>>()
        .ok_or_else(|| {
            RpcError::new(
                tonic::Code::Internal,
