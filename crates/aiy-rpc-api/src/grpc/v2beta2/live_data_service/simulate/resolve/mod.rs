...
use aiy_rpc::proto::google::rpc::bad_request::FieldViolation;
use aiy_rpc::proto::aiy::rpc::v2beta2::Transaction;
...
pub fn resolve_transaction(
    ...
    let ptb = unresolved_transaction
        ...
        .and_then(|kind| {
            kind.kind.as_ref().and_then(|kind| {
                match kind {
                aiy_rpc::proto::aiy::rpc::v2beta2::transaction_kind::Kind::ProgrammableTransaction(
                    ptb,
                ) => Some(ptb),
                _ => None,
            }
    ...
    let commands = ptb
        .commands
        .iter()
        .map(aiy_sdk_types::Command::try_from)
...
pub(super) fn called_packages(
    ...
    let binary_config = aiy_types::execution_config_utils::to_binary_config(protocol_config);
...
fn resolve_unresolved_transaction(
    ...
    reference_gas_price: u64,
    max_gas_budget: u64,
    sender: aiy_sdk_types::Address,
    unresolved_inputs: &[aiy_rpc::proto::aiy::rpc::v2beta2::Input],
    commands: Vec<Command>,
    gas_payment: Option<&aiy_rpc::proto::aiy::rpc::v2beta2::GasPayment>,
    expiration: Option<&aiy_rpc::proto::aiy::rpc::v2beta2::TransactionExpiration>,
) -> Result<TransactionData> {
    ...
    let expiration = expiration
        .map(aiy_types::transaction::TransactionExpiration::try_from)
        .transpose()
        .map_err(|e| {
        ...
        .unwrap_or(aiy_types::transaction::TransactionExpiration::None);
    let ptb = resolve_ptb(reader, called_packages, unresolved_inputs, commands)?;
    Ok(TransactionData::V1(
        aiy_types::transaction::TransactionDataV1 {
            kind: aiy_types::transaction::TransactionKind::ProgrammableTransaction(ptb),
            sender: sender.into(),
            gas_data,
            expiration,
        },
...
fn resolve_gas_object_reference(
    ...
    let Ok(gas_coin) = aiy_types::gas_coin::GasCoin::try_from(&object) else {
...
fn resolve_object_reference_with_object(
    object: &aiy_types::object::Object,
    unresolved_object_reference: UnresolvedObjectReference,
) -> Result<ObjectRef> {
    ...
    match object.owner() {
        aiy_types::object::Owner::AddressOwner(_) | aiy_types::object::Owner::Immutable => {}
        _ => {
...
fn resolve_arg(
    ...
    called_packages: &mut NormalizedPackages,
    commands: &[Command],
    arg: &aiy_rpc::proto::aiy::rpc::v2beta2::Input,
    arg_idx: usize,
) -> Result<CallArg> {
    use aiy_rpc::proto::aiy::rpc::v2beta2::input::InputKind;
...
fn resolve_object(
    ...
    arg_idx: usize,
    object_id: Address,
    version: Option<aiy_sdk_types::Version>,
    digest: Option<aiy_sdk_types::Digest>,
    ...
    match object.owner() {
        aiy_types::object::Owner::Immutable => resolve_object_reference_with_object(
            &object,
            UnresolvedObjectReference {
                object_id,
                version,
        ...
        aiy_types::object::Owner::AddressOwner(_) => {
        ...
        aiy_types::object::Owner::Shared { .. }
        | aiy_types::object::Owner::ConsensusAddressOwner { .. } => {
            resolve_shared_input_with_object(called_packages, commands, arg_idx, object)
        }
        aiy_types::object::Owner::ObjectOwner(_) => Err(RpcError::new(
            tonic::Code::InvalidArgument,
...
fn is_input_argument_receiving(
    ...
    let (receiving_package, receiving_module, receiving_struct) =
        aiy_types::transfer::RESOLVED_RECEIVING_STRUCT;
...
fn arg_type_of_move_call_input(
    called_packages: &NormalizedPackages,
    move_call: &aiy_sdk_types::MoveCall,
    idx: usize,
...
fn resolve_shared_input_with_object(
    ...
    let initial_shared_version = if let aiy_types::object::Owner::Shared {
...
impl TryFrom<&aiy_rpc::proto::aiy::rpc::v2beta2::ObjectReference> for UnresolvedObjectReference {
    type Error = FieldViolation;

    fn try_from(
        value: &aiy_rpc::proto::aiy::rpc::v2beta2::ObjectReference,
...
struct UnresolvedInput<'a> {
    pub kind: Option<aiy_rpc::proto::aiy::rpc::v2beta2::input::InputKind>,
    pub pure: Option<&'a Bytes>,
    pub object_id: Option<aiy_sdk_types::Address>,
    pub version: Option<aiy_sdk_types::Version>,
    pub digest: Option<aiy_sdk_types::Digest>,
...
impl<'a> UnresolvedInput<'a> {
    fn from_proto(
        input: &'a aiy_rpc::proto::aiy::rpc::v2beta2::Input,
