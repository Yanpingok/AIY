...
use aiy_rpc::proto::aiy::rpc::v2beta2 as proto;
use aiy_rpc::proto::aiy::rpc::v2beta2::ledger_service_client::LedgerServiceClient;
use aiy_rpc::proto::aiy::rpc::v2beta2::transaction_execution_service_client::TransactionExecutionServiceClient;
...
use aiy_types::messages_checkpoint::{CertifiedCheckpointSummary, CheckpointSequenceNumber};
use aiy_types::object::Object;
use aiy_types::transaction::Transaction;

pub use aiy_rpc::client::ResponseExt;
...
pub struct TransactionExecutionResponse {
    ...
    pub balance_changes: Vec<aiy_sdk_types::BalanceChange>,
    pub input_objects: Vec<aiy_types::object::Object>,
    pub output_objects: Vec<aiy_types::object::Object>,
}
...
fn certified_checkpoint_summary_try_from_proto(
    ...
    let signature = aiy_types::crypto::AuthorityStrongQuorumSignInfo::from(
        aiy_sdk_types::ValidatorAggregatedSignature::try_from(
            checkpoint
                .signature
                .as_ref()
...
fn checkpoint_data_try_from_proto(
    ...
    let checkpoint_contents = checkpoint
        ...
        .deserialize::<aiy_types::messages_checkpoint::CheckpointContents>()
        ...
        .map(
            |(
                ...
                Result::<_, TryFromProtoError>::Ok(
                    aiy_types::full_checkpoint_content::CheckpointTransaction {
                        transaction,
                        effects,
                        events,
                        input_objects,
