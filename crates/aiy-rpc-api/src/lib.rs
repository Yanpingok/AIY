...
use aiy_types::transaction_executor::TransactionExecutor;
use tap::Pipe;
...
pub struct RpcService {
    ...
    chain_id: aiy_types::digests::ChainIdentifier,
...
impl RpcService {
    ...
    pub fn chain_id(&self) -> aiy_types::digests::ChainIdentifier {
        self.chain_id
    }
    ...
    pub async fn into_router(self) -> axum::Router {
        ...
        let router = {
            let ledger_service =
                aiy_rpc::proto::aiy::rpc::v2::ledger_service_server::LedgerServiceServer::new(
                    self.clone(),
                )
                .send_compressed(tonic::codec::CompressionEncoding::Zstd);
            let transaction_execution_service = aiy_rpc::proto::aiy::rpc::v2::transaction_execution_service_server::TransactionExecutionServiceServer::new(self.clone())
                .send_compressed(tonic::codec::CompressionEncoding::Zstd);
            let state_service =
                aiy_rpc::proto::aiy::rpc::v2::state_service_server::StateServiceServer::new(
                    self.clone(),
                )
                .send_compressed(tonic::codec::CompressionEncoding::Zstd);
            let signature_verification_service = aiy_rpc::proto::aiy::rpc::v2::signature_verification_service_server::SignatureVerificationServiceServer::new(self.clone())
                .send_compressed(tonic::codec::CompressionEncoding::Zstd);
            let move_package_service = aiy_rpc::proto::aiy::rpc::v2::move_package_service_server::MovePackageServiceServer::new(self.clone())
                .send_compressed(tonic::codec::CompressionEncoding::Zstd);
            let name_service =
                aiy_rpc::proto::aiy::rpc::v2::name_service_server::NameServiceServer::new(
                    self.clone(),
                )
                .send_compressed(tonic::codec::CompressionEncoding::Zstd);

            let ledger_service2 =
                aiy_rpc::proto::aiy::rpc::v2beta2::ledger_service_server::LedgerServiceServer::new(
                    self.clone(),
                );
            let transaction_execution_service2 = aiy_rpc::proto::aiy::rpc::v2beta2::transaction_execution_service_server::TransactionExecutionServiceServer::new(self.clone());
            let live_data_service2 =
                aiy_rpc::proto::aiy::rpc::v2beta2::live_data_service_server::LiveDataServiceServer::new(
                    self.clone(),
                ).send_compressed(tonic::codec::CompressionEncoding::Zstd);
            let signature_verification_service2 = aiy_rpc::proto::aiy::rpc::v2beta2::signature_verification_service_server::SignatureVerificationServiceServer::new(self.clone());
            let move_package_service2 = aiy_rpc::proto::aiy::rpc::v2beta2::move_package_service_server::MovePackageServiceServer::new(self.clone());
            ...
            let reflection_v1 = tonic_reflection::server::Builder::configure()
                ...
                .register_encoded_file_descriptor_set(
                    aiy_rpc::proto::aiy::rpc::v2::FILE_DESCRIPTOR_SET,
                )
                .register_encoded_file_descriptor_set(
                    aiy_rpc::proto::aiy::rpc::v2beta2::FILE_DESCRIPTOR_SET,
                )
...
aiy_rpc::proto::aiy::rpc::v2::subscription_service_server::SubscriptionServiceServer::new(self.clone());
                health_reporter
                    .set_service_status(
...
aiy_rpc::proto::aiy::rpc::v2beta2::subscription_service_server::SubscriptionServiceServer::new(subscription_service_handle);
                health_reporter
                    .set_service_status(
