...
use aiy_indexer_alt_schema::checkpoints::StoredGenesis;
use aiy_indexer_alt_schema::epochs::StoredEpochStart;
use aiy_indexer_alt_schema::MIGRATIONS;
use aiy_synthetic_ingestion::synthetic_ingestion::read_ingestion_data;
