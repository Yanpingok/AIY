...
use aiy_indexer_alt::args::Args;
use aiy_indexer_alt::args::Command;
use aiy_indexer_alt::config::IndexerConfig;
use aiy_indexer_alt::config::Merge;
use aiy_indexer_alt::setup_indexer;
use aiy_indexer_alt_framework::postgres::reset_database;
use aiy_indexer_alt_metrics::uptime;
use aiy_indexer_alt_metrics::MetricsService;
...
async fn main() -> Result<()> {
    ...
    match args.command {
        ...
        Command::Benchmark {
            ...
            let indexer_config = read_config(&config).await?;
            aiy_indexer_alt::benchmark::run_benchmark(
                database_url,
                db_args,
                benchmark_args,
                indexer_config,
