...
use aiy_indexer_alt_framework::types::{
    full_checkpoint_content::CheckpointData,
    aiy_system_state::{get_aiy_system_state, AiySystemStateTrait},
...
pub async fn bootstrap(
    ...
    let BootstrapGenesis {
        ...
        None => {
            ...
            let aiy_system_state =
                get_aiy_system_state(&genesis_transaction.output_objects.as_slice())
            ...
            let stored_genesis = StoredGenesis {
                ...
                initial_protocol_version: aiy_system_state.protocol_version() as i64,
            };
            let stored_epoch_start = StoredEpochStart {
                epoch: 0,
                protocol_version: aiy_system_state.protocol_version() as i64,
                cp_lo: 0,
                start_timestamp_ms: aiy_system_state.epoch_start_timestamp_ms() as i64,
                reference_gas_price: aiy_system_state.reference_gas_price() as i64,
                system_state: bcs::to_bytes(&aiy_system_state)
