...
use std::str::FromStr;
use aiy_data_ingestion_core::{DataIngestionMetrics, IndexerExecutor, ReaderOptions, WorkerPool};
use aiy_kvstore::{BigTableClient, BigTableProgressStore, KeyValueStoreReader, KvWorker};
        ...
        Some(Command::Ingestion { network }) => {
            ...
            executor
                .run(
                    ...
                    Some(format!("https://checkpoints.{}.aiy.io", network)),
                    vec![],
