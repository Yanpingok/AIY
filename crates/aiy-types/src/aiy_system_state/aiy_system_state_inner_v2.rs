...
use super::aiy_system_state_inner_v1::ValidatorV1;
use super::aiy_system_state_summary::{AiySystemStateSummary, AiyValidatorSummary};
use super::{AdvanceEpochParams, AiySystemStateTrait};
...
use crate::aiy_system_state::get_validators_from_table_vec;
use crate::aiy_system_state::aiy_system_state_inner_v1::{
    StakeSubsidyV1, StorageFundV1, ValidatorSetV1,
};
use serde::{Deserialize, Serialize};

/// Rust version of the Move aiy::aiy_system::SystemParametersV2 type
...
/// Rust version of the Move aiy_system::aiy_system::AiySystemStateInnerV2 type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct AiySystemStateInnerV2 {
    pub epoch: u64,
...
impl AiySystemStateTrait for AiySystemStateInnerV2 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
