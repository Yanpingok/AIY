...
use super::epoch_start_aiy_system_state::EpochStartValidatorInfoV1;
use super::aiy_system_state_summary::{AiySystemStateSummary, AiyValidatorSummary};
use super::{get_validators_from_table_vec, AdvanceEpochParams, AiySystemStateTrait};
use crate::balance::Balance;
use crate::base_types::{ObjectID, AiyAddress};
...
/// Rust version of the Move aiy::aiy_system::SystemParameters type
...
impl VerifiedValidatorMetadataV1 {
    pub fn aiy_pubkey_bytes(&self) -> AuthorityPublicKeyBytes {
...
impl ValidatorMetadataV1 {
    ...
    pub fn verify(&self) -> Result<VerifiedValidatorMetadataV1, u64> {
        ...
        verify_proof_of_possession(&pop, &protocol_pubkey, self.aiy_address)
            .map_err(|_| E_METADATA_INVALID_POP)?;
...
/// Rust version of the Move aiy::validator::Validator type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
...
impl ValidatorV1 {
    ...
    pub fn into_aiy_validator_summary(self) -> AiyValidatorSummary {
        let Self {
            metadata:
                ValidatorMetadataV1 {
                    aiy_address,
            ...
            staking_pool:
                StakingPoolV1 {
                    ...
                    aiy_balance: staking_pool_aiy_balance,
                    rewards_pool,
                    pool_token_balance,
                    exchange_rates:
                        Table {
...
/// Rust version of the Move aiy_system::staking_pool::StakingPool type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct StakingPoolV1 {
    ...
    pub pending_total_aiy_withdraw: u64,
    pub pending_pool_token_withdraw: u64,
    pub extra_fields: Bag,
}

/// Rust version of the Move aiy_system::validator_set::ValidatorSet type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct ValidatorSetV1 {
    ...
    pub at_risk_validators: VecMap<AiyAddress, u64>,
    pub extra_fields: Bag,
}

/// Rust version of the Move aiy_system::storage_fund::StorageFund type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
...
/// Rust version of the Move aiy_system::aiy_system::AiySystemStateInner type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct AiySystemStateInnerV1 {
    pub epoch: u64,
    ...
    pub validator_report_records: VecMap<AiyAddress, VecSet<AiyAddress>>,
...
impl AiySystemStateTrait for AiySystemStateInnerV1 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
    ...
    fn get_current_epoch_committee(&self) -> CommitteeWithNetworkMetadata {
        let validators = self
            ...
            .map(|validator| {
                ...
                let name = verified_metadata.aiy_pubkey_bytes();
                (
                    name,
                    (
    ...
    fn into_aiy_system_state_summary(self) -> AiySystemStateSummary {
        // If you are making any changes to AiySystemStateV1 or any of its dependent types before
        // mainnet, please also update AiySystemStateSummary and its corresponding TS type.
...
/// Rust version of the Move aiy_system::validator_cap::UnverifiedValidatorOperationCap type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct UnverifiedValidatorOperationCapV1 {
    pub id: ObjectID,
    pub authorizer_validator_address: AiyAddress,
}
