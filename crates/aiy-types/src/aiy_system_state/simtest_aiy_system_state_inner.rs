...
use crate::aiy_system_state::aiy_system_state_summary::{
    AiySystemStateSummary, AiyValidatorSummary,
};
use crate::aiy_system_state::{AdvanceEpochParams, AiySystemStateTrait};
...
pub struct SimTestAiySystemStateInnerV1 {
    pub epoch: u64,
...
impl AiySystemStateTrait for SimTestAiySystemStateInnerV1 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
    ...
    fn into_aiy_system_state_summary(self) -> AiySystemStateSummary {
        AiySystemStateSummary::default()
    }
}

#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct SimTestAiySystemStateInnerShallowV2 {
...
impl AiySystemStateTrait for SimTestAiySystemStateInnerShallowV2 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
...
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct SimTestAiySystemStateInnerDeepV2 {
    pub new_dummy_field: u64,
    pub epoch: u64,
    pub protocol_version: u64,
    pub system_state_version: u64,
...
impl AiySystemStateTrait for SimTestAiySystemStateInnerDeepV2 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
