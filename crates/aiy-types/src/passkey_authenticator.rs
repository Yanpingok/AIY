...
impl<'de> Deserialize<'de> for PasskeyAuthenticator {
        ...
        D: Deserializer<'de>,
    {
        ...
        serializable
            .try_into()
            .map_err(|e: AiyError| Error::custom(e.to_string()))
    }
}
...
impl Serialize for PasskeyAuthenticator {
    ...
    {
        let mut bytes = Vec::with_capacity(Secp256r1AiySignature::LENGTH);
        ...
        let raw = RawPasskeyAuthenticator {
            ...
            user_signature: Signature::Secp256r1AiySignature(
                Secp256r1AiySignature::from_bytes(&bytes).unwrap(), // ok to unwrap since the bytes are constructed as valid above.
            ),
        };
...
impl PasskeyAuthenticator {
    ...
    pub fn get_pk(&self) -> AiyResult<PublicKey> {
    ...
    pub fn signature(&self) -> Signature {
        ...
        Signature::Secp256r1AiySignature(Secp256r1AiySignature::from_bytes(&bytes).unwrap())
    }
}
...
impl AuthenticatorTrait for PasskeyAuthenticator {
        ...
        T: Serialize,
    {
        ...
        if author != AiyAddress::from(&self.get_pk()?) {
            return Err(AiyError::InvalidSignature {
