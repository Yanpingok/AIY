...
//! Rust bindings for `aiy::funds_accumulator`
...
/// Rust bindings for the Move struct `aiy::funds_accumulator::Withdrawal`.
...
impl Withdrawal {
    pub fn new(owner: AiyAddress, limit: U256) -> Self {
        Self { owner, limit }
    }
