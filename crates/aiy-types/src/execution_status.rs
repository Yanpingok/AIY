...
pub enum ExecutionFailureStatus {
    ...
    InsufficientGas,
    #[error("Invalid Gas Object. Possibly not address-owned or possibly not a AIY coin.")]
    InvalidGasObject,
    ...
    #[error(
        ...
        Please run the Aiy Move Verifier for more information."
    )]
    ...
    #[error(
        "Aiy Move Bytecode Verification Timeout. \
        Please run the Aiy Move Verifier for more information."
    )]
