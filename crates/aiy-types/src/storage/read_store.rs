...
use crate::base_types::{EpochId, ObjectID, ObjectType, SequenceNumber, AiyAddress};
...
pub trait RpcIndexes: Send + Sync {
    ...
    fn get_balance(&self, owner: &AiyAddress, coin_type: &StructTag)
...
pub struct EpochInfo {
    ...
    pub system_state: Option<crate::aiy_system_state::AiySystemState>,
    // pub end_of_epoch_transaction: Option<TransactionDigest>,
    // pub epoch_commitments: Vec<aiy_types::messages_checkpoint::CheckpointCommitment>,
}
