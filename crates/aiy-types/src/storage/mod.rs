...
use crate::base_types::{
    ConsensusObjectSequenceKey, FullObjectID, FullObjectRef, AiyAddress, TransactionDigest,
    VersionNumber,
};
use crate::committee::EpochId;
use crate::effects::{TransactionEffects, TransactionEffectsAPI};
use crate::error::{ExecutionError, AiyError};
...
) -> AiyResult<PackageFetchResults<PackageObject>> {
...
pub fn get_module_by_id<S: BackingPackageStore>(
    store: &S,
    id: &ModuleId,
) -> anyhow::Result<Option<CompiledModule>, AiyError> {
...
impl BackingPackageStore for TrackingBackingStore<'_> {
    fn get_package_object(
        &self,
        package_id: &ObjectID,
    ) -> crate::error::AiyResult<Option<PackageObject>> {
...
impl ChildObjectResolver for TrackingBackingStore<'_> {
    fn read_child_object(
        ...
        child: &ObjectID,
        child_version_upper_bound: SequenceNumber,
    ) -> crate::error::AiyResult<Option<Object>> {
        self.inner
