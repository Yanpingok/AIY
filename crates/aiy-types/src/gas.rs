...
pub mod checked {
    ...
    use crate::{
        ...
        error::{ExecutionError, AiyResult, UserInputError, UserInputResult},
        gas_model::{gas_v2::AiyGasStatus as AiyGasStatusV2, tables::GasStatus},
        object::Object,
    ...
    #[enum_dispatch(AiyGasStatusAPI)]
    #[derive(Debug)]
    pub enum AiyGasStatus {
    ...
    impl AiyGasStatus {
        pub fn new(
            ...
            Ok(Self::V2(AiyGasStatusV2::new_with_budget(
                gas_budget,
                gas_price,
                reference_gas_price,
                config,
        ...
        pub fn new_unmetered() -> Self {
            Self::V2(AiyGasStatusV2::new_unmetered())
        }

        // This is the only public API on AiyGasStatus, all other gas related operations should
