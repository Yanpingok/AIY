...
use crate::{
    ...
    object::Owner,
    storage::ObjectStore,
    AIY_COIN_REGISTRY_OBJECT_ID, AIY_FRAMEWORK_ADDRESS,
};
...
/// Rust representation of `aiy::coin_registry::CurrencyKey<T>`.
#[derive(Serialize, Deserialize, Copy, Clone, Default, PartialEq, Eq)]
pub struct CurrencyKey(bool);

/// Rust representation of `aiy::coin_registry::Currency<phantom T>`.
...
/// Rust representation of `aiy::coin_registry::SupplyState<phantom T>`.
#[derive(Serialize, Deserialize)]
...
/// Rust representation of `aiy::coin_registry::RegulatedState`.
#[derive(Serialize, Deserialize)]
...
/// Rust representation of `aiy::coin_registry::MetadataCapState`.
#[derive(Serialize, Deserialize)]
...
/// Rust representation of `aiy::coin_registry::ExtraField`.
#[derive(Serialize, Deserialize)]
...
impl Currency {
    /// Derive the ObjectID for `aiy::coin_registry::Currency<$coin_type>`.
    ...
    /// Is this `StructTag` a `aiy::coin_registry::Currency<...>`?
...
pub fn get_coin_registry_obj_initial_shared_version(
    ...
    Ok(object_store
        .get_object(&AIY_COIN_REGISTRY_OBJECT_ID)
