...
use crate::base_types::{ObjectID, AiyAddress, TransactionDigest};
...
/// A universal Aiy event type encapsulating different types of events
...
/// Unique ID of a Aiy Event, the ID is a combination of transaction digest and event seq number.
#[serde_as]
...
impl Event {
    ...
    pub fn is_system_epoch_info_event(&self) -> bool {
        self.type_.address == AIY_SYSTEM_ADDRESS
            && self.type_.module.as_ident_str() == ident_str!("aiy_system_state_inner")
