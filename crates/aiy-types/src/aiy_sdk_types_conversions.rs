...
//! Module for conversions between aiy-core types and aiy-sdk types
//!
...
use crate::crypto::AiySignature as _;
...
impl From<crate::base_types::AiyAddress> for Address {
    fn from(value: crate::base_types::AiyAddress) -> Self {
        Self::new(value.to_inner())
    }
}

impl From<Address> for crate::base_types::AiyAddress {
...
impl From<crate::execution_status::ExecutionFailureStatus> for ExecutionError {
    fn from(value: crate::execution_status::ExecutionFailureStatus) -> Self {
        match value {
            ...
            crate::execution_status::ExecutionFailureStatus::AiyMoveVerificationError => Self::AiyMoveVerificationError,
            ...
            crate::execution_status::ExecutionFailureStatus::AiyMoveVerificationTimedout => Self::AiyMoveVerificationTimedout,
...
impl From<ExecutionError> for crate::execution_status::ExecutionFailureStatus {
    fn from(value: ExecutionError) -> Self {
        match value {
            ...
            ExecutionError::AiyMoveVerificationError => Self::AiyMoveVerificationError,
            ...
            ExecutionError::AiyMoveVerificationTimedout => Self::AiyMoveVerificationTimedout,
...
impl TryFrom<crate::crypto::Signature> for SimpleSignature {
    ...
    fn try_from(value: crate::crypto::Signature) -> Result<Self, Self::Error> {
        match value {
            crate::crypto::Signature::Ed25519AiySignature(ed25519_aiy_signature) => Self::Ed25519 {
                signature: Ed25519Signature::from_bytes(ed25519_aiy_signature.signature_bytes())?,
                public_key: Ed25519PublicKey::from_bytes(ed25519_aiy_signature.public_key_bytes())?,
            },
            crate::crypto::Signature::Secp256k1AiySignature(secp256k1_aiy_signature) => {
                Self::Secp256k1 {
                    signature: Secp256k1Signature::from_bytes(
                        secp256k1_aiy_signature.signature_bytes(),
                    )?,
                    public_key: Secp256k1PublicKey::from_bytes(
                        secp256k1_aiy_signature.public_key_bytes(),
                    )?,
                }
            }

            crate::crypto::Signature::Secp256r1AiySignature(secp256r1_aiy_signature) => {
                Self::Secp256r1 {
                    signature: Secp256r1Signature::from_bytes(
                        secp256r1_aiy_signature.signature_bytes(),
                    )?,
                    public_key: Secp256r1PublicKey::from_bytes(
                        secp256r1_aiy_signature.public_key_bytes(),
                    )?,
                }
            }
        }
