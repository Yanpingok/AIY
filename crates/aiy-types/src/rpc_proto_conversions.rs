...
//! Module for conversions from aiy-core types to rpc protos

use crate::crypto::AiySignature;
use crate::message_envelope::Message as _;
use aiy_rpc::field::FieldMaskTree;
use aiy_rpc::merge::Merge;
use aiy_rpc::proto::aiy::rpc::v2::*;
use aiy_rpc::proto::TryFromProtoError;
    ...
    fn merge(&mut self, source: &crate::full_checkpoint_content::Checkpoint, mask: &FieldMaskTree) {
            ...
            .and_then(|submask| submask.subtree(ObjectSet::OBJECTS_FIELD))
        {
            let set = source
                .object_set
                .iter()
                .map(|o| aiy_rpc::proto::aiy::rpc::v2::Object::merge_from(o, &submask))
                .collect();
            ...
            self.transactions = source
                ...
                .map(|t| {
                    ...
                    transaction.timestamp = submask
                        ...
                        .then(|| aiy_rpc::proto::timestamp_ms_to_proto(timestamp_ms));
                    transaction
                })
                .collect();
        }
...
impl Merge<crate::messages_checkpoint::CheckpointSummary> for CheckpointSummary {
    fn merge(
        ...
        if mask.contains(Self::TIMESTAMP_FIELD) {
            self.timestamp = Some(aiy_rpc::proto::timestamp_ms_to_proto(timestamp_ms));
        }
...
impl From<crate::aiy_system_state::AiySystemState> for SystemState {
    fn from(value: crate::aiy_system_state::AiySystemState) -> Self {
        match value {
            crate::aiy_system_state::AiySystemState::V1(v1) => v1.into(),
            crate::aiy_system_state::AiySystemState::V2(v2) => v2.into(),
...
impl From<crate::aiy_system_state::aiy_system_state_inner_v1::AiySystemStateInnerV1>
    for SystemState
{
    fn from(
        crate::aiy_system_state::aiy_system_state_inner_v1::AiySystemStateInnerV1 {
            epoch,
            protocol_version,
...
impl From<crate::aiy_system_state::aiy_system_state_inner_v2::AiySystemStateInnerV2>
    for SystemState
{
    fn from(
        crate::aiy_system_state::aiy_system_state_inner_v2::AiySystemStateInnerV2 {
            epoch,
            protocol_version,
            system_state_version,
            validators,
...
impl From<crate::aiy_system_state::aiy_system_state_inner_v1::StakeSubsidyV1> for StakeSubsidy {
    fn from(
        crate::aiy_system_state::aiy_system_state_inner_v1::StakeSubsidyV1 {
            balance,
...
impl From<crate::aiy_system_state::aiy_system_state_inner_v1::SystemParametersV1>
    for SystemParameters
{
    fn from(
        crate::aiy_system_state::aiy_system_state_inner_v1::SystemParametersV1 {
            epoch_duration_ms,
...
impl From<crate::aiy_system_state::aiy_system_state_inner_v2::SystemParametersV2>
    for SystemParameters
{
    fn from(
        crate::aiy_system_state::aiy_system_state_inner_v2::SystemParametersV2 {
            epoch_duration_ms,
            stake_subsidy_start_epoch,
            min_validator_count,
            max_validator_count,
...
impl From<crate::aiy_system_state::aiy_system_state_inner_v1::StorageFundV1> for StorageFund {
    fn from(
        crate::aiy_system_state::aiy_system_state_inner_v1::StorageFundV1 {
...
impl From<crate::aiy_system_state::aiy_system_state_inner_v1::ValidatorSetV1> for ValidatorSet {
    fn from(
        crate::aiy_system_state::aiy_system_state_inner_v1::ValidatorSetV1 {
            total_stake,
            active_validators,
...
impl From<crate::aiy_system_state::aiy_system_state_inner_v1::StakingPoolV1> for StakingPool {
    fn from(
        crate::aiy_system_state::aiy_system_state_inner_v1::StakingPoolV1 {
            id,
            activation_epoch,
            deactivation_epoch,
            aiy_balance,
        ...
        message.aiy_balance = Some(aiy_balance);
        ...
        message.pending_total_aiy_withdraw = Some(pending_total_aiy_withdraw);
...
impl From<crate::aiy_system_state::aiy_system_state_inner_v1::ValidatorV1> for Validator {
    fn from(
        crate::aiy_system_state::aiy_system_state_inner_v1::ValidatorV1 {
            metadata:
                crate::aiy_system_state::aiy_system_state_inner_v1::ValidatorMetadataV1 {
                    aiy_address,
        ...
        message.address = Some(aiy_address.to_string());
...
impl From<&crate::zk_login_authenticator::ZkLoginAuthenticator> for ZkLoginAuthenticator {
    fn from(value: &crate::zk_login_authenticator::ZkLoginAuthenticator) -> Self {
        ...
        aiy_sdk_types::ZkLoginAuthenticator::try_from(value.clone())
            .map(Into::into)
            .ok()
            .unwrap_or(message)
    }
...
impl From<&crate::crypto::ZkLoginPublicIdentifier> for ZkLoginPublicIdentifier {
    fn from(value: &crate::crypto::ZkLoginPublicIdentifier) -> Self {
        //TODO implement this without going through the sdk type
        aiy_sdk_types::ZkLoginPublicIdentifier::try_from(value.to_owned())
            .map(|id| (&id).into())
            .ok()
            .unwrap_or_default()
    }
...
impl From<crate::messages_consensus::ConsensusCommitPrologue> for ConsensusCommitPrologue {
    fn from(value: crate::messages_consensus::ConsensusCommitPrologue) -> Self {
        ...
        message.commit_timestamp = Some(aiy_rpc::proto::timestamp_ms_to_proto(
...
impl From<crate::messages_consensus::ConsensusCommitPrologueV4> for ConsensusCommitPrologue {
    fn from(
        ...
        message.commit_timestamp = Some(aiy_rpc::proto::timestamp_ms_to_proto(commit_timestamp_ms));
...
impl From<crate::transaction::ChangeEpoch> for ChangeEpoch {
    fn from(value: crate::transaction::ChangeEpoch) -> Self {
        ...
        message.epoch_start_timestamp = Some(aiy_rpc::proto::timestamp_ms_to_proto(
...
impl From<&crate::coin_registry::Currency> for CoinMetadata {
    fn from(value: &crate::coin_registry::Currency) -> Self {
        ...
        metadata.id = Some(aiy_sdk_types::Address::from(value.id.into_bytes()).to_string());
        ...
        match &value.metadata_cap_id {
            crate::coin_registry::MetadataCapState::Claimed(id) => {
                ...
                metadata.metadata_cap_id = Some(aiy_sdk_types::Address::from(*id).to_string());
            }
            crate::coin_registry::MetadataCapState::Unclaimed => {
...
impl From<crate::coin::CoinMetadata> for CoinMetadata {
    fn from(value: crate::coin::CoinMetadata) -> Self {
        let mut metadata = CoinMetadata::default();
        metadata.id = Some(aiy_sdk_types::Address::from(value.id.id.bytes).to_string());
        metadata.decimals = Some(value.decimals.into());
...
impl From<crate::coin::TreasuryCap> for CoinTreasury {
    fn from(value: crate::coin::TreasuryCap) -> Self {
        ...
        treasury.id = Some(aiy_sdk_types::Address::from(value.id.id.bytes).to_string());
    ...
    fn from(value: &crate::coin_registry::RegulatedState) -> Self {
        ...
        match value {
            crate::coin_registry::RegulatedState::Regulated {
                ...
                regulated.deny_cap_object = Some(aiy_sdk_types::Address::from(*cap).to_string());
...
impl From<crate::coin::RegulatedCoinMetadata> for RegulatedCoinMetadata {
    fn from(value: crate::coin::RegulatedCoinMetadata) -> Self {
        ...
        message.id = Some(aiy_sdk_types::Address::from(value.id.id.bytes).to_string());
        message.coin_metadata_object =
            Some(aiy_sdk_types::Address::from(value.coin_metadata_object.bytes).to_string());
        message.deny_cap_object =
            Some(aiy_sdk_types::Address::from(value.deny_cap_object.bytes).to_string());
