...
mod checked {
    ...
    use crate::gas::{self, GasCostSummary, GasUsageReport, AiyGasStatusAPI};
    ...
    /// A list of constant costs of various operations in Aiy.
    pub struct AiyCostTable {
    ...
    impl std::fmt::Debug for AiyCostTable {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            // TODO: dump the fields.
            write!(f, "AiyCostTable(...)")
        }
    }
    ...
    pub struct PerObjectStorage {
        ...
        /// storage_rebate is the storage rebate (in Aiy) for in this object.
    ...
    impl AiyGasStatus {
        ...
        pub(crate) fn new_with_budget(
            ...
            let aiy_cost_table = AiyCostTable::new(config, gas_price);
            let gas_rounding_step = config.gas_rounding_step_as_option();
            Self::new(
                GasStatus::new(
                    aiy_cost_table.execution_cost_table.clone(),
                    computation_budget,
                    gas_price,
        ...
        pub fn new_unmetered() -> AiyGasStatus {
            Self::new(
    ...
    impl AiyGasStatusAPI for AiyGasStatus {
