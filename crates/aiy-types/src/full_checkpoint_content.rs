...
use crate::aiy_system_state::get_aiy_system_state;
use crate::aiy_system_state::AiySystemStateTrait;
...
impl CheckpointData {
    ...
    pub fn epoch_info(&self) -> Result<Option<EpochInfo>, StorageError> {
        ...
        let system_state =
            get_aiy_system_state(&transaction.output_objects.as_slice()).map_err(|e| {
...
impl BackingPackageStore for CheckpointData {
    ...
    ) -> crate::error::AiyResult<Option<crate::storage::PackageObject>> {
        self.transactions
            .iter()
