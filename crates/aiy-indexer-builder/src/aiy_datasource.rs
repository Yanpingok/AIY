...
pub struct AiyCheckpointDatasource {
...
#[async_trait]
impl Datasource<CheckpointTxnData> for AiyCheckpointDatasource {
    async fn start_data_retrieval(
        ...
        tracing::info!(
            "Starting Aiy checkpoint data retrieval with batch size {}",
...
impl Worker for IndexerWorker<CheckpointTxnData> {
    ...
    async fn process_checkpoint(&self, checkpoint: &AiyCheckpointData) -> anyhow::Result<()> {
        tracing::trace!(
            "Received checkpoint [{}] {}: {}",
