...
use aiy_types::base_types::{AuthorityName, EpochId, ObjectID, AiyAddress};
use aiy_types::committee::{Committee, StakeUnit};
...
impl From<Committee> for AiyCommittee {
...
pub struct DelegatedStake {
    /// Validator's Address.
    pub validator_address: AiyAddress,
...
#[serde(rename_all = "camelCase")]
pub struct Stake {
    /// ID of the StakedAiy receipt object.
    pub staked_aiy_id: ObjectID,
    #[schemars(with = "BigInt<u64>")]
    #[serde_as(as = "BigInt<u64>")]
