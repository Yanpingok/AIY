...
use aiy_types::event::{Event, EventEnvelope, EventID};
...
pub type EventPage = Page<AiyEvent, EventID>;
...
impl From<EventEnvelope> for AiyEvent {
...
impl From<AiyEvent> for Event {
    fn from(val: AiyEvent) -> Self {
        Event {
...
impl Filter<AiyEvent> for EventFilter {
    fn matches(&self, item: &AiyEvent) -> bool {
