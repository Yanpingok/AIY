...
pub use aiy_checkpoint::*;
pub use aiy_coin::*;
pub use aiy_event::*;
pub use aiy_extended::*;
pub use aiy_governance::*;
pub use aiy_move::*;
pub use aiy_object::*;
pub use aiy_protocol::*;
pub use aiy_transaction::*;
...
pub struct DynamicFieldInfo {
    pub name: aiy_types::dynamic_field::DynamicFieldName,
    #[serde(flatten)]
    pub bcs_name: BcsName,
    pub type_: aiy_types::dynamic_field::DynamicFieldType,
    pub object_type: String,
    pub object_id: ObjectID,
    pub version: aiy_types::base_types::SequenceNumber,
    pub digest: aiy_types::digests::ObjectDigest,
}

impl From<aiy_types::dynamic_field::DynamicFieldInfo> for DynamicFieldInfo {
    fn from(
        aiy_types::dynamic_field::DynamicFieldInfo {
            name,
            bcs_name,
            type_,
            object_type,
