...
impl TryFrom<Object> for AiyCoinMetadata {
    type Error = AiyError;
...
impl From<CoinMetadata> for AiyCoinMetadata {
...
impl From<coin_registry::Currency> for AiyCoinMetadata {
