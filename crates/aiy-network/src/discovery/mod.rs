...
use aiy_config::p2p::{AccessType, DiscoveryConfig, P2pConfig, SeedPeer};
use aiy_types::crypto::{NetworkKeyPair, Signer, ToFromBytes, VerifyingKey};
...
mod generated {
    include!(concat!(env!("OUT_DIR"), "/aiy.Discovery.rs"));
}
mod builder;
mod metrics;
mod server;
