...
use aiy_config::p2p::StateSyncConfig;
use aiy_types::{
    committee::Committee,
...
mod generated {
    include!(concat!(env!("OUT_DIR"), "/aiy.StateSync.rs"));
}
mod builder;
mod metrics;
mod server;
...
use aiy_config::node::ArchiveReaderConfig;
use aiy_data_ingestion_core::{setup_single_workflow_with_options, ReaderOptions};
    ...
    S: WriteStore + Clone + Send + Sync + 'static,
{
    ...
    if sync_from_archive {
        ...
        if ingestion_url.contains("checkpoints.mainnet.aiy.io") {
