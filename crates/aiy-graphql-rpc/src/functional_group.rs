...
pub enum FunctionalGroup {
    ...
    /// AiyNS name and reverse name look-up.
    NameService,
...
impl FunctionalGroup {
    ...
    /// Not a aiytable `Display` implementation because it enquotes the representation.
...
fn functional_groups() -> &'static BTreeMap<(&'static str, &'static str), FunctionalGroup> {
    ...
    static GROUPS: Lazy<BTreeMap<(&str, &str), FunctionalGroup>> = Lazy::new(|| {
        BTreeMap::from_iter([
            ...
            (("Address", "defaultAiynsName"), G::NameService),
            (("Address", "aiynsRegistrations"), G::NameService),
            ...
            (("Query", "resolveAiynsAddress"), G::NameService),
