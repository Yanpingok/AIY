...
use async_graphql::*;
use aiy_types::aiy_system_state::aiy_system_state_summary::AiySystemStateSummary as NativeSystemStateSummary;
...
impl SystemStateSummary {
    ...
    /// The value of the `version` field of `0x5`, the `0x3::aiy::AiySystemState` object.  This
