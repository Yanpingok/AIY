...
use super::aiyns_registration::{DomainFormat, NameService, AiynsRegistration};
use crate::data::Db;
...
use crate::types::aiy_address::AiyAddress;
...
#[graphql(
    name = "IOwner",
    field(name = "address", ty = "AiyAddress"),
    field(
        name = "objects",
    ...
    field(
        ...
        desc = "Total balance of all coins with marker type owned by this object or address. If \
                type is not supplied, it defaults to `0x2::aiy::AIY`."
    ),
    field(
        name = "balances",
        arg(name = "first", ty = "Option<u64>"),
    ...
    field(
        ...
        arg(name = "last", ty = "Option<u64>"),
        arg(name = "before", ty = "Option<object::Cursor>"),
        ty = "Connection<String, StakedAiy>",
        desc = "The `0x3::staking_pool::StakedAiy` objects owned by this object or address."
    ),
    field(
        name = "default_aiyns_name",
    ...
    field(
        name = "aiyns_registrations",
        arg(name = "first", ty = "Option<u64>"),
        arg(name = "after", ty = "Option<object::Cursor>"),
        arg(name = "last", ty = "Option<u64>"),
        arg(name = "before", ty = "Option<object::Cursor>"),
        ty = "Connection<String, AiynsRegistration>",
        desc = "The AiynsRegistration NFTs owned by this object or address. These grant the owner \
...
/// An Owner is an entity that can own an object. Each Owner is identified by a AiyAddress which
...
impl Owner {
    ...
    /// supplied, it defaults to `0x2::aiy::AIY`.
    ...
    /// The `0x3::staking_pool::StakedAiy` objects owned by this object or address.
    ...
    /// The AiynsRegistration NFTs owned by this object or address. These grant the owner the
