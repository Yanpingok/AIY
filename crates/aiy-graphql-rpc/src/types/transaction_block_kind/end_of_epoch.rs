...
use aiy_types::digests::ChainIdentifier as AiyChainIdentifier;
use aiy_types::{
...
impl ChangeEpochTransaction {
    ...
    /// The AIY returned to transaction senders for cleaning up objects (in MIST).
    ...
    async fn system_packages(
        ...
        for c in cs {
            ...
            let object = Object::from_native(AiyAddress::from(runtime_id), native, c.c, None);
