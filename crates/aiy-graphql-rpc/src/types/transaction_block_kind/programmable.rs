...
use aiy_json_rpc_types::AiyArgument;
...
impl MoveCallTransaction {
    ...
    async fn package(&self) -> AiyAddress {
    ...
    fn from(pt: NativeProgrammableTransaction, checkpoint_viewed_at: u64) -> Self {
        ...
        match pt {
            ...
            N::Publish(modules, dependencies) => P::Publish(PublishTransaction {
                ...
                dependencies: dependencies.into_iter().map(AiyAddress::from).collect(),
            }),
...
impl From<AiyArgument> for TransactionArgument {
    fn from(argument: AiyArgument) -> Self {
        use AiyArgument as S;
        use TransactionArgument as A;
        match argument {
