...
use async_graphql::*;
use aiy_json_rpc_types::BalanceChange as StoredBalanceChange;
use aiy_types::object::Owner as NativeOwner;

use super::{big_int::BigInt, move_type::MoveType, owner::Owner, aiy_address::AiyAddress};
...
impl BalanceChange {
    ...
    /// The inner type of the coin whose balance has changed (e.g. `0x2::aiy::AIY`).
