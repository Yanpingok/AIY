...
use async_graphql::*;
use aiy_types::base_types::ObjectRef as NativeObjectRef;

use super::{object::Object, aiy_address::AiyAddress, uint53::UInt53};
...
impl ObjectRead {
    ...
    async fn address(&self) -> AiyAddress {
        self.address_impl()
    }
...
impl ObjectRead {
    fn address_impl(&self) -> AiyAddress {
        AiyAddress::from(self.native.0)
    }
