...
use super::{big_int::BigInt, move_type::MoveType, aiy_address::AiyAddress};
...
pub(crate) struct Balance {
    /// Coin type for the balance, such as 0x2::aiy::AIY
...
/// `RawQuery`.
fn filter(mut query: RawQuery, owner: AiyAddress, coin_type: Option<TypeTag>) -> RawQuery {
