...
use super::{
    ...
    aiyns_registration::{DomainFormat, AiynsRegistration},
...
impl Address {
    ...
    /// The `0x3::staking_pool::StakedAiy` objects owned by this address.
    ...
    /// The AiynsRegistration NFTs owned by this address. These grant the owner the capability to
