...
fn select_ev(sender: Option<AiyAddress>, from: &str) -> RawQuery {
...
pub(crate) fn select_sender(sender: AiyAddress) -> RawQuery {
    select_ev(Some(sender), "event_senders")
}

pub(crate) fn select_event_type(event_type: &TypeFilter, sender: Option<AiyAddress>) -> RawQuery {
    match event_type {
