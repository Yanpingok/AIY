...
use aiy_types::move_package;

use crate::consistency::{ConsistentIndexCursor, ConsistentNamedCursor};
use crate::error::Error;
use aiy_package_resolver::Module as ParsedMoveModule;
...
use super::{base64::Base64, move_package::MovePackage, aiy_address::AiyAddress};

#[derive(Clone)]
pub(crate) struct MoveModule {
    pub storage_id: AiyAddress,
    pub native: Vec<u8>,
