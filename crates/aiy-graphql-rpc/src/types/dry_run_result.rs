...
use async_graphql::*;
use aiy_json_rpc_types::{DevInspectResults, AiyExecutionResult};
use aiy_types::effects::TransactionEffects as NativeTransactionEffects;
use aiy_types::transaction::TransactionData as NativeTransactionData;
...
impl TryFrom<AiyExecutionResult> for DryRunEffect {
    type Error = crate::error::Error;

    fn try_from(result: AiyExecutionResult) -> Result<Self, Self::Error> {
