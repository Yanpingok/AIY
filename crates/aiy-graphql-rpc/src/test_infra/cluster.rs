...
use aiy_graphql_rpc_client::simple_client::SimpleClient;
pub use aiy_indexer::config::RetentionConfig;
pub use aiy_indexer::config::SnapshotLagConfig;
use aiy_indexer::errors::IndexerError;
use aiy_indexer::store::PgIndexerStore;
use aiy_indexer::test_utils::start_indexer_writer_for_testing;
use aiy_pg_db::temp::{get_available_port, TempDb};
...
/// Takes in a simulated instantiation of a Aiy blockchain and builds a cluster around it. This
...
pub async fn serve_executor(
    ...
    let executor_server_handle = tokio::spawn(async move {
        aiy_rpc_api::RpcService::new(executor)
