...
use aiy_types::effects::TransactionEffects as NativeTransactionEffects;
use aiy_types::event::Event as NativeEvent;
use aiy_types::quorum_driver_types::ExecuteTransactionRequestType;
use aiy_types::transaction::SenderSignedData;
use aiy_types::{signature::GenericSignature, transaction::Transaction};
pub struct Mutation;

/// Mutations are used to write to the Aiy network.
#[Object]
impl Mutation {
    ...
    async fn execute_transaction_block(
        ...
        let options = AiyTransactionBlockResponseOptions::new()
            .with_events()
            .with_raw_input()
            .with_raw_effects();

        let result = aiy_sdk_client
            .quorum_driver_api()
