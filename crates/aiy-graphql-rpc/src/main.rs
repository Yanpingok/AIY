...
use clap::Parser;
use aiy_graphql_rpc::commands::Command;
use aiy_graphql_rpc::config::{ServerConfig, ServiceConfig, Version};
use aiy_graphql_rpc::server::graphiql_server::start_graphiql_server;
...
// VERSION mimics what other aiy binaries use for the same const
