...
pub struct WatchdogMetrics {
    ...
    pub aiy_bridge_paused: IntGauge,
}
    ...
    pub fn new(registry: &Registry) -> Self {
        Self {
            ...
            total_supplies: register_int_gauge_vec_with_registry!(
                ...
                "Current total supplies of coins on Aiy based on Treasury Cap",
                &["token_name"],
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            aiy_bridge_paused: register_int_gauge_with_registry!(
                "bridge_aiy_bridge_paused",
                "Whether the aiy bridge is paused",
                registry,
            )
            .unwrap(),
        }
