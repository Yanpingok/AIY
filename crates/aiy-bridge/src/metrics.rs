...
pub struct BridgeMetrics {
    pub(crate) err_build_aiy_transaction: IntCounter,
    pub(crate) err_signature_aggregation: IntCounter,
    pub(crate) err_signature_aggregation_too_many_failures: IntCounter,
    pub(crate) err_aiy_transaction_submission: IntCounter,
    pub(crate) err_aiy_transaction_submission_too_many_failures: IntCounter,
    pub(crate) err_aiy_transaction_execution: IntCounter,
    ...
    pub(crate) last_synced_aiy_checkpoints: IntGaugeVec,
    pub(crate) last_finalized_eth_block: IntGauge,
    pub(crate) last_synced_eth_blocks: IntGaugeVec,

    pub(crate) aiy_watcher_received_events: IntCounter,
    pub(crate) aiy_watcher_received_actions: IntCounter,
    pub(crate) aiy_watcher_unrecognized_events: IntCounter,
    ...
    pub(crate) aiy_rpc_errors: IntCounterVec,
    ...
    pub(crate) aiy_eth_token_transfer_approved: IntCounter,
    pub(crate) aiy_eth_token_transfer_claimed: IntCounter,
    pub(crate) eth_aiy_token_transfer_approved: IntCounter,
    pub(crate) eth_aiy_token_transfer_claimed: IntCounter,
}

impl BridgeMetrics {
    pub fn new(registry: &Registry) -> Self {
        Self {
            err_build_aiy_transaction: register_int_counter_with_registry!(
                "bridge_err_build_aiy_transaction",
                "Total number of errors of building aiy transactions",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            err_aiy_transaction_submission: register_int_counter_with_registry!(
                "bridge_err_aiy_transaction_submission",
                "Total number of errors of submitting aiy transactions",
                registry,
            )
            .unwrap(),
            err_aiy_transaction_submission_too_many_failures: register_int_counter_with_registry!(
                "bridge_err_aiy_transaction_submission_too_many_failures",
                "Total number of continuous failures to submitting aiy transactions",
                registry,
            )
            .unwrap(),
            err_aiy_transaction_execution: register_int_counter_with_registry!(
                "bridge_err_aiy_transaction_execution",
                "Total number of failures of aiy transaction execution",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            aiy_watcher_received_events: register_int_counter_with_registry!(
                "bridge_aiy_watcher_received_events",
                "Total number of received events in aiy watcher",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            aiy_watcher_received_actions: register_int_counter_with_registry!(
                "bridge_aiy_watcher_received_actions",
                "Total number of received actions in aiy watcher",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            aiy_watcher_unrecognized_events: register_int_counter_with_registry!(
                "bridge_aiy_watcher_unrecognized_events",
                "Total number of unrecognized events in aiy watcher",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            last_synced_aiy_checkpoints: register_int_gauge_vec_with_registry!(
                "bridge_last_synced_aiy_checkpoints",
                "The latest aiy checkpoints synced for each module",
                &["module_name"],
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            aiy_rpc_errors: register_int_counter_vec_with_registry!(
                "bridge_aiy_rpc_errors",
                "Total number of errors from aiy RPC, by RPC method",
                &["method"],
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            aiy_eth_token_transfer_approved: register_int_counter_with_registry!(
                "bridge_aiy_eth_token_transfer_approved",
                "Total number of approved aiy to eth token transfers (since metric introduced). \
                Should be used to track rates rather than absolute values.",
                registry,
            )
            .unwrap(),
            aiy_eth_token_transfer_claimed: register_int_counter_with_registry!(
                "bridge_aiy_eth_token_transfer_claimed",
                "Total number of claimed aiy to eth token transfers (since metric introduced). \
                Should be used to track rates rather than absolute values.",
                registry,
            )
            .unwrap(),
            eth_aiy_token_transfer_approved: register_int_counter_with_registry!(
                "bridge_eth_aiy_token_transfer_approved",
                "Total number of approved eth to aiy token transfers (since metric introduced). \
                Should be used to track rates rather than absolute values.",
                registry,
            )
            .unwrap(),
            eth_aiy_token_transfer_claimed: register_int_counter_with_registry!(
                "bridge_eth_aiy_token_transfer_claimed",
                "Total number of claimed eth to aiy token transfers (since metric introduced). \
                Should be used to track rates rather than absolute values.",
                registry,
            )
            .unwrap(),
