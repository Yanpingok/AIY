...
pub enum BridgeError {
    ...
    // Found a bridge event but not in a recognized Aiy bridge package
    BridgeEventInUnrecognizedAiyPackage,
    ...
    // Aiy transaction failure due to generic error
    AiyTxFailureGeneric(String),
