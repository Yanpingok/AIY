...
use aiy_types::{
    base_types::AiyAddress, digests::TransactionDigest,
...
impl Command {
    ...
    pub fn new_pay_aiy() -> Self {
        Self {
            data: CommandData::PayAiy(PayAiy {}),
            ..Default::default()
        }
    }
    ...
    pub fn new_get_all_balances(addresses: Vec<AiyAddress>, chunk_size: usize) -> Self {
