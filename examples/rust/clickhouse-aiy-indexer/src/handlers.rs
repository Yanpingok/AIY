...
use aiy_indexer_alt_framework_store_traits::Store;
...
/// Aligned with aiy-indexer-alt's StoredTxDigest structure
...
/// Named to align with aiy-indexer-alt's TxDigests handler
