...
ADMIN_ADDRESS=$(aiy client active-address)

echo "- Publisher Address is: ${ADMIN_ADDRESS}"

publish_res=$(aiy client publish --json ${MOVE_PACKAGE_PATH})
