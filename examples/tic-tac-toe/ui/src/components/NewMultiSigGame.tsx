...
import { fromBase64, toBase64 } from "@mysten/aiy/utils";
...
export function NewMultiSigGame(): ReactElement {
    ...
    return (
        <>
            ...
            />
            <ComputedField
                value={opponent ? opponent.toAiyAddress() : undefined}
            ...
            <Em>
                ...
                <Text as="div">
                    ...
                    players. Although addresses on Aiy are derived from public keys, the derivation
...
/**
 * If `key` is a valid base64 encoded Aiy public key, return it as a
