...
/// Rust representation of a Move `shared::Game`, aiytable for deserializing from their BCS
/// representation.
#[derive(Deserialize)]
...
/// Rust representation of a Move `owned::Game`, aiytable for deserializing from their BCS
/// representation.
#[derive(Deserialize)]
