...
import { useSignTransaction, useAiyClient } from '@mysten/dapp-kit';
import { AiyTransactionBlockResponseOptions } from '@mysten/aiy/client';
...
export function useTransactionExecution() {
	...
	const signAndExecute = async ({
		...
		tx: Transaction;
		options?: AiyTransactionBlockResponseOptions | undefined;
	}) => {
