...
import { MIST_PER_AIY } from '@mysten/aiy/utils';
					...
					<Button
						...
						onClick={() =>
							placeAndListToKioskMutation.mutate({
								item,
								price: (Number(price) * Number(MIST_PER_AIY)).toString(),
