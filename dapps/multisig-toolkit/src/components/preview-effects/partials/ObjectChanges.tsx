...
import { AiyObjectChange } from '@mysten/aiy/client';
...
// SPDX-License-Identifier: Apache-2.0
export function ObjectChanges({ objects }: { objects: AiyObjectChange[] }) {
	return (
...
function ChangedObject({ object }: { object: AiyObjectChange }) {
