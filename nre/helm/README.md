...
# GraphQL
### Containers
**graphql** - container running aiy-graphql rpc endpoint. Requires a Database updated by the indexer-writer.
...
# Indexer-Reader
### Containers
**indexer-reader** - aiy-indexer-reader jsonrpc endpoint. This offers backwards compatibility with current aiy-node json rpc. This deployment is only needed as we transition to the graphql service. This is not needed if you do not want to support the jsonrpc.
...
# Indexer-Writer
### Containers
**aiy-indexer-writer** - Indexer writer syncs and indexes aiy checkpoint data into a Postgres database. Checkpoint data can be pulled from a fullnode or a cloud provider hosted bucket. More info and available buckets can be found in aiy [doc site](https://docs.sui.io/guides/developer/advanced/custom-indexer#remote-reader).
