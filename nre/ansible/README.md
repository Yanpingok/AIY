# Configure a Linux system as a Aiy Node using Ansible

This is a self contained Ansible role for configuring a Linux system as a Aiy Node.
...
3. Update the `aiy_release` var in the [Ansible Inventory](./inventory.yaml)
...
`ansible-playbook -i inventory.yaml aiy-node.yaml -e host=$inventory_name`
