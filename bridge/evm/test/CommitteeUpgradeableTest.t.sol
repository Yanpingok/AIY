...
contract CommitteeUpgradeableTest is BridgeBaseTest {
    ...
    function setUp() public {
        ...
        address _config = Upgrades.deployUUPSProxy(
            ...
            abi.encodeCall(
                ...
                (_committee, _chainID, supportedTokens, tokenPrices, tokenIds, aiyDecimals, _supportedDestinationChains)
            ),
            opts
        );
        ...
        address _bridge = Upgrades.deployUUPSProxy(
            "AiyBridge.sol",
            abi.encodeCall(AiyBridge.initialize, (_committee, address(0), address(0))),
            opts
        );

        bridge = AiyBridge(_bridge);
        bridgeV2 = new MockAiyBridgeV2();
    }

    function testUpgradeWithSignaturesSuccess() public {
        bytes memory initializer = abi.encodeCall(MockAiyBridgeV2.initializeV2, ());
    ...
    function testUpgradeRegressionTestWith1CalldataArg() public {
        ...
        MockAiyBridgeV2 newBridgeV2 = MockAiyBridgeV2(address(bridge));
    ...
    function testUpgradeRegressionTestWithNoCalldata() public {
        ...
        MockAiyBridgeV2(address(bridge));
        assertEq(Upgrades.getImplementationAddress(address(bridge)), address(bridgeV2));
    }
}
