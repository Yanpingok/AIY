...
interface IBridgeConfig {
    ...
    function tokenAiyDecimalOf(uint8 tokenID) external view returns (uint8);
    ...
    /// @param aiyDecimals The added token's decimal places on Aiy.
    ...
    event TokenAdded(uint8 tokenID, address tokenAddress, uint8 aiyDecimal, uint64 tokenPrice);
