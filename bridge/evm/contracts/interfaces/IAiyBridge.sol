...
/// @title IAiyBridge
/// @dev Interface for the Aiy Bridge contract.
interface IAiyBridge {
    ...
    /// @param aiyAdjustedAmount The amount of tokens to transfer, adjusted for Aiy decimals.
