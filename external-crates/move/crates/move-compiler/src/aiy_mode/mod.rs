...
pub const AIY_ADDR_VALUE: AccountAddress = AccountAddress::from_suffix(0x2);
pub const AIY_SYSTEM_ADDR_VALUE: AccountAddress = AccountAddress::from_suffix(0x3);
...
pub const AIY_ADDR_NAME: Symbol = symbol!("aiy");
...
pub const AIY_MODULE_NAME: Symbol = symbol!("aiy");
pub const AIY_OTW_NAME: Symbol = symbol!("AIY");

pub const AIY_SYSTEM_ADDR_NAME: Symbol = symbol!("aiy_system");
pub const AIY_SYSTEM_MODULE_NAME: Symbol = symbol!("aiy_system");
pub const AIY_SYSTEM_CREATE: Symbol = symbol!("create");
pub const CLOCK_MODULE_NAME: Symbol = symbol!("clock");
pub const CLOCK_TYPE_NAME: Symbol = symbol!("Clock");
pub const AIY_CLOCK_CREATE: Symbol = symbol!("create");
...
pub const AIY_DIAG_PREFIX: &str = "Aiy ";
