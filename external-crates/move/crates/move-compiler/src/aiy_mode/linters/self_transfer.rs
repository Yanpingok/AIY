...
use crate::{
    ...
    parser::ast::Ability_,
    aiy_mode::{AIY_ADDR_VALUE, TX_CONTEXT_MODULE_NAME},
};
...
const TRANSFER_FUNCTIONS: &[(AccountAddress, &str, &str)] = &[
    (AIY_ADDR_VALUE, TRANSFER_MOD_NAME, PUBLIC_TRANSFER_FUN),
...
impl SimpleAbsInt for SelfTransferVerifierAI {
    ...
    fn call_custom(
        ...
        if f.is(&AIY_ADDR_VALUE, TX_CONTEXT_MODULE_NAME, "sender") {
