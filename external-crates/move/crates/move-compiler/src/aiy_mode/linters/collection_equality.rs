...
//! This analysis flags situations when instances of a aiy::table::Table or aiy::table_vec::TableVec
//! or aiy::bag::Bag are being compared for (in)equality at this type of comparison is not very
...
use crate::{
    ...
    parser::ast as P,
    aiy_mode::{AIY_ADDR_NAME, AIY_ADDR_VALUE},
...
const COLLECTION_TYPES: &[(Symbol, AccountAddress, &str, &str)] = &[
    (AIY_ADDR_NAME, AIY_ADDR_VALUE, BAG_MOD_NAME, BAG_STRUCT_NAME),
    (
        AIY_ADDR_NAME,
        AIY_ADDR_VALUE,
        OBJECT_BAG_MOD_NAME,
