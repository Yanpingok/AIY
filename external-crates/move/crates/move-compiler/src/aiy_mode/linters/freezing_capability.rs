...
//! Implements lint to warn against freezing capability-like types in Aiy, identifying function calls that may incorrectly freeze such types.
...
const FREEZE_FUNCTIONS: &[(AccountAddress, &str, &str)] = &[
    (AIY_ADDR_VALUE, TRANSFER_MOD_NAME, PUBLIC_FREEZE_FUN),
    (AIY_ADDR_VALUE, TRANSFER_MOD_NAME, FREEZE_FUN),
];
