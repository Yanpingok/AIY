...
const _: () = {
    ...
    assert!(BinaryFlavor::mask_and_shift_to_unflavor(x) == BinaryFlavor::AIY_FLAVOR);
};
...
impl BinaryFlavor {
    ...
    // The Aiy flavor is 0x05
    pub const AIY_FLAVOR: u8 = 0x05;
    ...
    const fn shift_and_flavor(unflavored: u32) -> u32 {
        ((Self::AIY_FLAVOR as u32) << Self::SHIFT_AMOUNT) | unflavored
    }
}
