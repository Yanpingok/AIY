...
/// Similar to `aiy::dynamic_field`, this module allows for the access of dynamic fields. But
/// unlike, `aiy::dynamic_field` the values bound to these dynamic fields _must_ be objects
...
module aiy::dynamic_object_field {
