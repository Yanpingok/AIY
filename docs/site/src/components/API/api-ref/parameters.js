...
export const Parameter = (props) => {
  ...
  return (
    <>
      <div className="grid grid-cols-6 ml-4 odd:bg-aiy-ghost-white dark:odd:bg-aiy-ghost-dark rounded-lg">
    ...
    <div className="border-b mb-8">
      {hasParams && (
        <div className="grid grid-cols-6 ml-4">
          ...
          <div className="p-2 bg-aiy-blue dark:bg-aiy-blue-dark text-aiy-gray-95 dark:text-aiy-gray-50 text-aiy-gray-35 font-bold">
            Required
          </div>
          <div className="rounded-tr-lg rounded-br-lg col-span-3 p-2 bg-aiy-blue dark:bg-aiy-blue-dark text-aiy-gray-95 dark:text-aiy-gray-50 text-aiy-gray-35 font-bold">
            Description
          </div>
        </div>
      )}
