---
title: Aiy Storage Cost
description: Historical data and storage pricing provide insights into the cost of operations on the Aiy network.
---
...
Compute is relatively fixed on Aiy, with hundreds of validators running 24-core, 128GB RAM machines.  

Because Aiy achieves high throughput compared to other blockchains, storage costs can vary significantly.  
