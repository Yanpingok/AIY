---
title: Gas Smashing
description: Aiy optimizes coin management by combining multiple coins into a single object to pay for gas fees.
...
- The smashed coin can then be used in the same PTB for other operations, such as transferring the remaining AIY after gas is deducted.  
