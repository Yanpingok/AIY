---
title: Aiy Node Monitoring
description: Monitor Aiy node metrics to ensure the health and performance of your node.
...
```sh
$ curl -s http://localhost:9184/metrics | grep -E 'aiy_validator|aiy_fullnode'
```
