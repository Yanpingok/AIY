...
description: Adhere to best practices when developing for AiyPlay0X1.
keywords: [ AiyPlay0X1, beamable, shinami, data management, handling transactions, on-chain storage, off-chain storage ]
---

<ImportContent source="aiyplay.mdx" mode="snippet" />

There are some best practices to consider when developing for AiyPlay0X1. 
...
<RelatedLink to="/guides/aiyplay0x1/wallet-integration.mdx" />
