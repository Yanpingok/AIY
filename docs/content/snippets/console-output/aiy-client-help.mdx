...
Usage: aiy client [OPTIONS] [COMMAND]
...
Commands:
  ...
  envs                        List all Aiy environments
  ...
  new-address                 Generate new address and keypair with keypair scheme flag {ed25519
                                  ...
                                  specified
  new-env                     Add new Aiy environment
  ...
  pay-all-aiy                 Pay all residual AIY coins to the recipient with input coins,
                                  after deducting the gas cost. The input coins also include the
                                  coin for gas payment, so no extra gas coin is required
  pay-aiy                     Pay AIY coins to recipients following following specified amounts,
  ...
  transfer-aiy                Transfer AIY, and pay gas with the same AIY coin object. If amount
...
Options:
      ...
      --client.env <ENV>        The Aiy environment to use. This must be present in the current
                                config file
