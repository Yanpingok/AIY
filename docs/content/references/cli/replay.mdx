---
title: Aiy Replay CLI
description: Use the Aiy CLI to replay a given transaction to view its effects.
---
...
The main command for replaying a transaction follows. For all available flags and arguments, run `aiy replay --help`.

```sh
$ aiy replay --digest <digest>
```
...
the gas cost, please refer to the [gas in aiy](../../concepts/tokenomics/gas-in-aiy.mdx) page.
